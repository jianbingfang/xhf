...
<aside id="m-sidebar" class="accordion span2"><!-- data-spy="affix" data-offset-top="100" -->
    ...
    <div class="accordion-group">
        <div class="accordion-heading">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#m-sidebar" href="javascript:void(0)"
               onclick="zd('collapse-bpm-process')">
                <i class="icon-book "></i>
    ...
    <div class="accordion-group">
        ...
        <div id="collapse-xmgl" class="accordion-body collapse ${currentMenu == 'gcgl-xmgl' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
                ...
                <li><a href="${scopePrefix}/gcgl/pjFirstCheck-info-list.do"><i class="icon-certificate"></i>首次工作检查</a>
                </li>
    ...
    <div class="accordion-group">
        ...
        <div id="collapse-xmda" class="accordion-body collapse ${currentMenu == 'gcgl-xmda' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
                <li><a href="${scopePrefix}/gcgl/pjTemplate-info-list.do"><i class="icon-arrow-right"></i>上报资料清单</a>
                </li>
    ...
    <div class="accordion-group">
        ...
        <div id="collapse-jlb" class="accordion-body collapse ${currentMenu == 'gcgl-jlb' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
                ...
                <li><a href="${scopePrefix}/gcgl/pjGuifantuji-info-list.do?type=1"><i class="icon-user"></i>规范图集</a>
                </li>
                ...
                <li><a href="${scopePrefix}/gcgl/pjGuifantuji-info-list.do?type=2"><i class="icon-user"></i>档案盒脊背</a>
                </li>
                <li><a href="${scopePrefix}/gcgl/pjTzTemplat-info-list.do"><i class="icon-user"></i>台账范本</a></li>
                <li><a href="${scopePrefix}/gcgl/pjPxjcjlTemplat-info-list.do"><i class="icon-user"></i>平行检查记录范本</a>
                </li>
            </ul>
        </div>
    </div>
