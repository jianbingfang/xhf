<%@ page language="java" pageEncoding="UTF-8" %>
      ...
      <aside id="m-sidebar" class="accordion span2" data-spy="affix" data-offset-top="100">
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-process" class="accordion-body collapse ${currentMenu == 'zbdl-zd' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/hr/zbdl-doc-bmzz.do"><i class="icon-user"></i>部门职责</a></li>
			  <li><a href="${scopePrefix}/hr/zbdl-doc-glzd-list.do"><i class="icon-user"></i>管理制度</a></li>
			  <li><a href="${scopePrefix}/hr/zbdl-doc-gzlc-list.do"><i class="icon-user"></i>工作流程</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-task" class="accordion-body collapse ${currentMenu == 'zbdl-plain' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/hr/zbdl-plain-info-list.do"><i class="icon-user"></i>月计划</a></li>
			  <li><a href="${scopePrefix}/hr/zbdl-week-plain-info-list.do"><i class="icon-user"></i>周计划</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="accordion-group">
          ...
          <div id="collapse-bpm-delegate" class="accordion-body collapse ${currentMenu == 'zbdl-xc' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${scopePrefix}/hr/zbdl-doc-xctx-list.do"><i class="icon-user"></i>薪酬体系</a></li>
            </ul>
          </div>
        </div>
