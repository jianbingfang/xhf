		...
		<section id="m-main" class="span10">
			...
			<article class="m-widget">
				...
				<div id="userSearch" class="content content-inner">
					...
					<form name="userForm" method="post" action="user-base-search.do"
						class="form-inline">
				...
				<div class="pull-left">
					<region:region-permission permission="user:create">
						<button class="btn btn-small"
							onclick="location.href='user-base-input.do'">新建</button>
			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					...
					<form id="userGridForm" name="userGridForm" method='post'
						action="user-base-remove.do" class="m-form-blank">
						<table id="userGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<th class="sorting" name="id"><spring:message
											code="user.user.list.id" text="编号" /></th>
									<th class="sorting" name="username"><spring:message
											code="user.user.list.username" text="账号" /></th>
									<th name="password"><spring:message
											code="user.user.list.password" text="密码" /></th>
									<th class="sorting" name="status"><spring:message
											code="user.user.list.status" text="状态" /></th>
									<th name="firstName"><spring:message
											code="user.user.list.code" text="编号" /></th>
									<th name="lastName"><spring:message
											code="user.user.list.email" text="邮箱" /></th>
									<th width="80">&nbsp;</th>
								</tr>
							</thead>
							...
							<tbody>
								<c:forEach value="${page.result}" var="item">
									<tr>
										<td><input type="checkbox" class="selectedItem"
										...
										<td><a href="user-base-input.do?id=${item.id}"><spring:message
