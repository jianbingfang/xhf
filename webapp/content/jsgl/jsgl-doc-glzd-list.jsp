...
var config = {
	...
	gridFormId: 'jsgl-doc-glzd-infoGridForm',
	exportUrl: 'jsgl-doc-glzd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="jsgl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="jsgl-plain-infoForm" method="post" action="jsgl-doc-glzd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='jsgl-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jsgl-doc-glzd-infoGridForm" name="jsgl-doc-glzd-infoGridForm" method='post' action="jsgl-doc-glzd-remove.do" class="m-form-blank">
  <table id="jsgl-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="jsgl-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
