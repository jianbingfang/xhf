...
var config = {
	...
	exportUrl: 'jsgl-week-plain-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='jsgl-week-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jsgl-plain-infoGridForm" name="jsgl-plain-infoGridForm" method='post' action="jsgl-week-plain-info-remove.do" class="m-form-blank">
  <table id="jsgl-plain-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fmemo5}</td>
        <td>
          <a href="jsgl-week-plain-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
