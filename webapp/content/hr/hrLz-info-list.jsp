...
<!-- <div class="container-fluid">
	<div class="row-fluid">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="hrLz-infoGridForm" name="hrLz-infoGridForm" method='post' action="hrLz-info-remove.do" class="m-form-blank">
  <table id="hrLz-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="hrLz-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
