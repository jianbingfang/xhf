...
var config = {
	...
	gridFormId: 'hrJiaqi-infoGridForm',
	exportUrl: 'hrJiaqi-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        <header class="header">
		  ...
		  <div class="ctrl">
		    <a class="btn"><i id="hrJiaqi-infoSearchIcon" class="icon-chevron-up"></i></a>
		  </div>
		</header>
        <div id="hrJiaqi-infoSearch" class="content content-inner">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="hrJiaqi-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='hrJiaqi-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="hrJiaqi-info.hrJiaqi-info.list.title" text="列表"/></h4>
		</header>
        <div class="content">
<form id="hrJiaqi-infoGridForm" name="hrJiaqi-infoGridForm" method='post' action="hrJiaqi-info-remove.do" class="m-form-blank">
  <table id="hrJiaqi-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	  <td>${ryMap[item.fryid].fname}</td>
      	 	 ...
      	 	 <td>${item.fgz}</td>
        <td>
          <a href="hrJiaqi-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
