...
<%pageContext.setAttribute("currentMenu", "hr-gzzj");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'hr-doc-gzzj-infoGridForm',
	exportUrl: 'hr-doc-gzzj-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='hr-doc-gzzj-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="hr-doc-gzzj-infoGridForm" name="hr-doc-gzzj-infoGridForm" method='post' action="hr-doc-gzzj-remove.do" class="m-form-blank">
  <table id="hr-doc-gzzj-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
