			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="plain-infoForm" method="post"
						action="hr-doc-gzlc-save.do" class="form-horizontal">
						...
						<%-- <div class="control-group">
							<label class="control-label" for="plain-info_fmonth"><spring:message
									code="plain-info.plain-info.input.ftitle" text="执行时间" /></label>
							<div class="controls">
							...
							<div class="controls">
								<div class="input-append datepicker date"
									...
									<input id="plain-info_fupdatedate" type="text"
										...
										class="text " minlength="2" maxlength="10" 
										style="background-color:white;cursor:default; width: 175px;">
									<span class="add-on"
										style="padding-top: 2px; padding-bottom: 2px;"><i
										class="icon-calendar"></i></span>
						...
						<%-- <div class="control-group">
							...
							<div class="controls">
								<input id="plain-info_creator" type="text" name="fcreator"
									value="${model.fcreator}" size="40" class="text "
