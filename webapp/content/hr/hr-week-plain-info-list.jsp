...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.hr-plain-info.list.title" text="人力资源 - 工作计划- 周计划"/></title>
    <%@include file="/common/s.jsp"%>
    <script type="text/javascript">
var config = {
    id: 'hr-week-plain-infoGrid',
    pageNo: ${page.pageNo},
	...
	exportUrl: 'hr-week-plain-info-export.do'
};
...
<!-- <div class="container-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='hr-week-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="hr-plain-infoGridForm" name="hr-plain-infoGridForm" method='post' action="hr-week-plain-info-remove.do" class="m-form-blank">
  <table id="hr-plain-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr ondblclick="window.location='hr-week-plain-info-input.do?id=${item.fid}'">
