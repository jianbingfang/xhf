...
<title><spring:message code="dev.hr-plain-info.list.title"
		text="工作流程 - 管理制度 - 人力资源" /></title>
<%@include file="/common/s.jsp"%>
<script type="text/javascript">
var config = {
    id: 'hr-doc-gzlc-infoGrid',
    pageNo: ${page.pageNo},
	...
	gridFormId: 'hr-doc-gzlc-infoGridForm',
	exportUrl: 'hr-doc-gzlc-export.do'
};
...
<body>
	...
	<!-- 		<div class="container-fluid">
			...
			<%-- <article class="m-widget">
				...
				<div id="hr-plain-infoSearch" class="content content-inner">
					...
					<form name="hr-plain-infoForm" method="post"
						action="hr-doc-gzlc-list.do" class="form-inline">
				...
				<div class="pull-left">
					<region:region-permission permission="hr-plain-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='hr-doc-gzlc-input.do'">新建</button>
			...
			<article class="m-widget">
				...
				<div class="content">
					<form id="hr-doc-gzlc-infoGridForm" name="hr-doc-gzlc-infoGridForm"
						method='post' action="hr-doc-gzlc-remove.do" class="m-form-blank">
						<table id="hr-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr ondblclick="window.location='hr-doc-gzlc-input.do?id=${item.fid}'">
										...
										<td><c:if test="${item.fstatus==1}">
											...
											</c:if> <c:if test="${item.fstatus==2}">
												<font color="red">实行</font>
											</c:if> <c:if test="${item.fstatus==3}">
