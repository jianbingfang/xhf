...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="dev.hrPx-info.list.title" text="外部培训 - 员工培训 - 人力资源"/></title>
...
var config = {
	...
	exportUrl: 'hrPx-wb-info-export.do'
};
	...
	<div class="row-fluid">
	  ...
	  <article class="m-widget">
        <header class="header">
		  ...
		  <div class="ctrl">
		    <a class="btn"><i id="hrPx-infoSearchIcon" class="icon-chevron-up"></i></a>
		  </div>
		</header>
        <div id="hrPx-infoSearch" class="content content-inner">
		  ...
		  <form name="hrPx-infoForm" method="post" action="hrPx-wb-info-list.do" class="form-inline">
		    ...
		    <input id="commRy-info_ruzhi" type="text" name="filter_GTD_fdate" value="${param.filter_GTD_fdate}" size="40" class="text "  style="background-color:white;cursor:default; width: 160px;">
		    <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
		  </div> 至
		   <div class="input-append datepicker date" style="padding-left: 0px;">
		    <input id="commRy-info_ruzhi" type="text" name="filter_LTD_fdate" value="${param.filter_LTD_fdate}" size="40" class="text "  style="background-color:white;cursor:default; width: 160px;">
		    <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
		  </div>
			<button class="btn btn-small a-search" onclick="document.hrPx-infoForm.submit()">查询</button>&nbsp;
		  </form>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='hrPx-wb-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="hrPx-info.hrPx-info.list.title" text="列表"/></h4>
		</header>
        <div class="content">
<form id="hrPx-infoGridForm" name="hrPx-infoGridForm" method='post' action="hrPx-wb-info-remove.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	  ...
      	  <td>${item.ftgrs}</td>
        <td>
          <a href="hrPx-wb-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
