	...
	<div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="hr-doc-xctx-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodule" value="hr">
			     <input id="plain-info_ftype" type="hidden" name="ftype" value="3">
