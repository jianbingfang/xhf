						...
						<table id="commRy-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<!-- <th class="sorting" name="fcardno">工号</th> -->
									<th class="sorting" id="fname">姓名</th>
									<th class="sorting" id="fsex">性别</th>
									<th class="sorting" id="fidno">身份证号</th>
									<!--         	<th class="sorting" id="faddress">家庭地址</th>
        	<th class="sorting" id="ftel">办公电话</th>
        	<th class="sorting" id="femail">办公邮箱</th> -->
									...
									<!-- <th class="sorting" id="fbyyx">毕业院校</th>
        	<th class="sorting" id="fjobid">岗位</th> -->
									<th width="160">&nbsp;</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr ondblclick="window.location='commRy-info-input.do?id=${item.fid}'">
										...
										<td>${item.fbydate }</td>
										<td> <a
											href="hrLdht-info-input.do?ryid=${item.fid}" class="a-update"><spring:message
													code="core.list.edit" text="" />合同</a>&nbsp; <a
											href="hrShtc-info-input.do?ryid=${item.fid}" class="a-update"><spring:message
													code="core.list.edit" text="" />统筹</a>&nbsp; <a
											href="hrRyZj-info-list.do?ryid=${item.fid}" class="a-update"><spring:message
													code="core.list.edit" text="" />证件</a>&nbsp;</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
