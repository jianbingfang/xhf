    ...
    <div class="row-fluid">
      ...
      <section id="m-main" class="span10">
      	<ul id="myTab" class="nav nav-tabs" role="tablist">
     	  	<li role="presentation" class="active"><a href="#tab1">内部调配</a></li>
     	   <li role="presentation" ><a href="#tab2">社会招聘</a></li>
        </ul>
	      <div class="tab-content">
		  	  <div class="tab-pane active" id="tab1">
				  <iframe src="hrRydb-info-list.do" height="600px" width="100%"  style="border: 0px;"></iframe>
			  </div>
