...
<title><spring:message code="dev.hr-plain-info.list.title"
		text="薪酬体系 - 人力资源" /></title>
<%@include file="/common/s.jsp"%>
<script type="text/javascript">
	var config = {
		id : 'hr-doc-xctx-infoGrid',
		pageNo : ${page.pageNo},
		...
		gridFormId : 'hr-doc-xctx-infoGridForm',
		exportUrl : 'hr-doc-xctx-export.do'
	};
		...
		<!-- 	<div class="container-fluid">
			...
			<article class="m-widget">
				<header class="header">
					...
					<div class="ctrl">
						<a class="btn"><i id="hr-plain-infoSearchIcon"
							class="icon-chevron-up"></i></a>
					</div>
				</header>
				<div id="hr-plain-infoSearch" class="content content-inner">
					<form name="hr-plain-infoForm" method="post"
						action="hr-doc-xctx-list.do" class="form-inline">
						<label for="hr-plain-info_name"><spring:message
								code='hr-plain-info.hr-plain-info.list.search.name' text='名称' />:</label>
						<input type="text" id="hr-plain-info_name"
							name="filter_LIKES_ftitle" value="${param.filter_LIKES_ftitle}">
						<button class="btn btn-small a-search"
							onclick="document.hr-plain-infoForm.submit()">查询</button>
						&nbsp;
					</form>
				</div>
			</article>
				...
				<div class="pull-left">
					<region:region-permission permission="hr-plain-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='hr-doc-xctx-input.do'">新建</button>
			...
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="hr-plain-info.hr-plain-info.list.title"
							text="列表" />
					</h4>
				</header>
				<div class="content">
					<form id="hr-doc-xctx-infoGridForm" name="hr-doc-xctx-infoGridForm"
						method='post' action="hr-doc-xctx-remove.do" class="m-form-blank">
						<table id="hr-doc-xctx-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr
										ondblclick="window.location='hr-doc-xctx-input.do?id=${item.fid}'">
