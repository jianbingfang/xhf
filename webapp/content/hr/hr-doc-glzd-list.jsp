...
var config = {
	...
	gridFormId: 'hr-doc-glzd-infoGridForm',
	exportUrl: 'hr-doc-glzd-export.do'
};
...
<!-- 			<div class="container-fluid">
				...
				<div class="pull-left">
					<region:region-permission permission="hr-plain-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='hr-doc-glzd-input.do'">新建</button>
			...
			<article class="m-widget">
				...
				<div class="content">
					<form id="hr-doc-glzd-infoGridForm" name="hr-doc-glzd-infoGridForm"
						method='post' action="hr-doc-glzd-remove.do" class="m-form-blank">
						<table id="hr-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr ondblclick="window.location='hr-doc-glzd-input.do?id=${item.fid}'">
