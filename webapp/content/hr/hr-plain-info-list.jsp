...
var config = {
	...
	gridFormId: 'hr-plain-infoGridForm',
	exportUrl: 'hr-plain-info-export.do'
};
	...
	<div class="row-fluid">
		...
		<!-- 	<div class="container-fluid">
				...
				<div class="pull-left">
					<region:region-permission permission="hr-plain-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='hr-plain-info-input.do'">新建</button>
			...
			<article class="m-widget">
				...
				<div class="content">
					<form id="hr-plain-infoGridForm" name="hr-plain-infoGridForm"
						method='post' action="hr-plain-info-remove.do"
						class="m-form-blank">
						<table id="hr-plain-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									<th width="10" class="m-table-check"><input
										type="checkbox" name="checkAll"
										onchange="toggleSelectedItems(this.checked)"></th>
									<th class="sorting" name="fcode"><spring:message
											code="hr-plain-info.hr-plain-info.list.name" text="序号" /></th>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr ondblclick="window.location='hr-plain-info-input.do?id=${item.fid}'">
