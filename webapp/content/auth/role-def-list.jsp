...
$(function() {
  ...
  <form id="roleDefGridForm" name="roleDefGridForm" method='post' action="role-def-remove.do" class="m-form-blank">
    <table id="roleDefGrid" class="m-table table-hover table-bordered">
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
	 	...
	 	<region:region-permission permission="roleDef:auth">
			...
			<region:region-permission permission="roleDef:auth">
            <a href="../sysconf/menu-role-input.do?roleid=${item.id}" class="a-config"><spring:message code="auth.roleDef.list.perm" text="菜单权限"/></a>
			</region:region-permission>
			<region:region-permission permission="roleDef:auth">
