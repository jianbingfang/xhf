...
var config = {
	...
	gridFormId: 'das-doc-gzlc-infoGridForm',
	exportUrl: 'das-doc-gzlc-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="das-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="das-plain-infoForm" method="post" action="das-doc-gzlc-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='das-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="das-doc-gzlc-infoGridForm" name="das-doc-gzlc-infoGridForm" method='post' action="das-doc-gzlc-remove.do" class="m-form-blank">
  <table id="das-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="das-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
