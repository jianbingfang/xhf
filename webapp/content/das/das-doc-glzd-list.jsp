...
<%pageContext.setAttribute("currentMenu", "das-zd");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'das-doc-glzd-infoGridForm',
	exportUrl: 'das-doc-glzd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="das-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="das-plain-infoForm" method="post" action="das-doc-glzd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='das-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="das-doc-glzd-infoGridForm" name="das-doc-glzd-infoGridForm" method='post' action="das-doc-glzd-remove.do" class="m-form-blank">
  <table id="das-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="das-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
