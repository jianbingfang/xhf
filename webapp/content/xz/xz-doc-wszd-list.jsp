...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.xz-plain-info.list.title" text="列表"/></title>
    <%@include file="/common/s.jsp"%>
    <script type="text/javascript">
var config = {
    id: 'xz-doc-wszd-infoGrid',
    pageNo: ${page.pageNo},
	...
	gridFormId: 'xz-doc-wszd-infoGridForm',
	exportUrl: 'xz-doc-wszd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="xz-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="xz-plain-infoForm" method="post" action="xz-doc-wszd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xz-doc-wszd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xz-doc-wszd-infoGridForm" name="xz-doc-wszd-infoGridForm" method='post' action="xz-doc-wszd-remove.do" class="m-form-blank">
  <table id="xz-doc-wszd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="xz-doc-wszd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
