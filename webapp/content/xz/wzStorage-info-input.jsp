    ...
    <article class="m-widget">
        ...
        <div class="content content-inner">
            ...
            <form id="wzStorage-infoForm" method="post" action="wzStorage-info-save.do" class="form-horizontal">
                ...
                <div class="control-group">
                    <label class="control-label" for="wzStorage-info_fxmid"><spring:message
                            code="wzStorage-info.wzStorage-info.input.fxmid" text="项目"/></label>
                ...
                <div class="control-group">
                    <label class="control-label" for="wzStorage-info_fxmid"><spring:message
                            code="wzStorage-info.wzStorage-info.input.fxmid" text="负责人"/></label>

                    <div class="controls">
                        <input id="wzStorage-info_fxmid" type="text" name="fxmid"
                               value="${ryMap[xmMap[model.fxmid].fxmzongjianid].fname}" size="" class="text   "
                               minlength="" maxlength="" readonly>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                    <label class="control-label" for="wzStorage-info_fjbr"><spring:message
                            code="wzStorage-info.wzStorage-info.input.fjbr" text="领取人"/></label>

                    <div class="controls">
                        <input id="wzStorage-info_fjbr" type="text" name="fjbr" value="${model.fjbr}" size=""
                               class="text  required " minlength="" maxlength="20">
                    </div>
                </div>
                <div class="control-group">
                    <div class="span5">
                ...
                <div class="control-group hidden">
                    ...
                    <div class="controls">
                        <input id="wzStorage-info_ftype" type="text" name="ftype" value="2" size="" class="text   "
