...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.xz-plain-info.list.title" text="管理制度 - 管理制度 - 行政管理"/></title>
    <%@include file="/common/s.jsp"%>
    <script type="text/javascript">
var config = {
    id: 'xz-doc-glzd-infoGrid',
    pageNo: ${page.pageNo},
	...
	gridFormId: 'xz-doc-glzd-infoGridForm',
	exportUrl: 'xz-doc-glzd-export.do'
};
	...
	<div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xz-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xz-doc-glzd-infoGridForm" name="xz-doc-glzd-infoGridForm" method='post' action="xz-doc-glzd-remove.do" class="m-form-blank">
  <table id="xz-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
...
<!--         <th class="sorting" name="fstartdate">开始时间</th>
    ...
    <tbody>
      ...
      <%--   <td>${item.fstartdate}</td>
        ...
        <td>${item.fcreator}</td> --%>
        <td>
          <a href="xz-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
