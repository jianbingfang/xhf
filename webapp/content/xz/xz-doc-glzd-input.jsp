...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="plain-info.plain-info.input.title" text="管理制度 - 管理制度 - 行政管理"/></title>
	...
	<div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="xz-doc-glzd-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <!-- <input id="plain-info_fmodulecode" type="hidden" name="fmodule" value="xz">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <input id="plain-info_ftitle" type="text" name="ftitle" value="${model.ftitle}" size="40" class="text" minlength="" maxlength="">
			    </div>
			  </div>
			    <div class="control-group">
			...
			<%--   <div class="control-group">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				  <div class="input-append datepicker date" style="padding-left: 0px;">
				    <input id="plain-info_fenddate" type="text" name="fenddate" value="${model.fenddate}" size="40" class="text "  readonly style="background-color:white;cursor:default; width: 175px;">
				    <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
				  </div>
