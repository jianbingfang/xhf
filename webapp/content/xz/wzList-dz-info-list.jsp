				...
				<div id="wzList-infoSearch" class="content content-inner">
					<form name="wzList-infoForm" method="post"
						...
						<label for="wzList-info_name"><spring:message
								code='wzList-info.wzList-info.list.search.name' text='名称' />:</label> <input
							type="text" id="wzList-info_name" name="filter_LIKES_name"
						...
						<table id="wzList-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<!-- <th class="sorting" id="fcode">物资编码</th> -->
									...
									<!-- <th class="sorting" name="flydate">领用日期</th>
        	<th class="sorting" name="fxmid">所在项目</th>
        	<th class="sorting" name="fsystate">使用状态</th>
        	<th class="sorting" name="fxjstate">新旧程度</th> -->
									<th width="80">&nbsp;</th>
								</tr>
							</thead>
							<tbody>
      	 	 ...
      	 	 <td>${item.fsystate}</td>
      	 	 <td>${item.fxjstate}</td> --%>
										<td><a href="wzList-dz-info-input.do?id=${item.fid}"
