...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="dev.xzDsj-info.list.title" text="列表" /></title>
...
var config = {
	...
	gridFormId: 'xzDsj-infoGridForm',
	exportUrl: 'xzDsj-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        <header class="header">
		  ...
		  <div class="ctrl">
		    <a class="btn"><i id="xzDsj-infoSearchIcon" class="icon-chevron-up"></i></a>
		  </div>
		</header>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="xzDsj-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='xzDsj-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="xzDsj-info.xzDsj-info.list.title" text="列表"/></h4>
		</header>
        <div class="content">
<form id="xzDsj-infoGridForm" name="xzDsj-infoGridForm" method='post' action="xzDsj-info-remove.do" class="m-form-blank">
  <table id="xzDsj-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
