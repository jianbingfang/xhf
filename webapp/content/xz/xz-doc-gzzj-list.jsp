...
var config = {
	...
	gridFormId: 'xz-doc-gzzj-infoGridForm',
	exportUrl: 'xz-doc-gzzj-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xz-doc-gzzj-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xz-doc-gzzj-infoGridForm" name="xz-doc-gzzj-infoGridForm" method='post' action="xz-doc-gzzj-remove.do" class="m-form-blank">
  <table id="xz-doc-gzzj-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
        <td>
          <a href="xz-doc-gzzj-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
