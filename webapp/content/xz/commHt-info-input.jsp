			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="commHt-infoForm" method="post"
						action="xz-commHt-info-save.do" class="form-horizontal">
						<c:if test="${model != null}">
							<input id="commHt-info_id" type="hidden" name="fid"
								value="${model.fid}">
						</c:if>
						<input id="commHt-info_fqiandingstatus" type="hidden" name="fqiandingstatus"
								value="5">
						...
						<div class="control-group">
							<div class="controls">
								...
								&nbsp;
								<button type="submit" class="btn a-submit"
									formaction="xz-commHt-info-saveinput.do">
									<spring:message code='core.input.saveinput' text='保存并继续添加' />
								</button>
								&nbsp;
