...
<form id="xzxjpy-infoForm" method="post" action="xzxjpy-wb-info-save.do" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="xzxjpy-info_id" type="hidden" name="fid" value="${model.fid}">
					...
					<%-- 	<div class="span5">
						...
						<div class="controls">
							  	 <input id="xzxjpy-info_ftype" type="text" name="ftype" value="外" size="" class="text required" minlength="" maxlength="">	
					    </div>
					    </div>
					    </div>
