...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="plain-info.plain-info.input.title" text="工作流程 - 管理制度 - 行政管理"/></title>
	...
	<div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="xz-doc-gzlc-save.do" class="form-horizontal">
