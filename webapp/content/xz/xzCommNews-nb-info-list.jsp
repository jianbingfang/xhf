...
<script type="text/javascript">
	var config = {
		...
		exportUrl : 'xzCommNews-nb-info-export.do'
	};
	...
	<div class="row-fluid">
		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				...
				<div id="xzCommNews-infoSearch" class="content content-inner">
					...
					<form name="xzCommNews-infoForm" method="post"
						action="xzCommNews-nb-info-list.do" class="form-inline">
						<label for="xzCommNews-info_fname"><spring:message
								code="xzCommNews-info.xzCommNews-info.list2.search.fname"
						...
						<label for="xzCommNews-info_ffnewcontent"><spring:message
								code="xzCommNews-info.xzCommNews-info.list2.search.fnewcontent"
							...
							for="commRy-info_fcreatedate"><spring:message
								code='commRy-info.commRy-info.list2.search.fcreatedate'
								text='发布时间' />:</label>
				...
				<div class="pull-left">
					<region:region-permission permission="xzCommNews-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='xzCommNews-nb-info-input.do'">新建</button>
			...
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="xzCommNews-info.xzCommNews-info.list2.title"
							text="列表" />
					</h4>
				</header>
				<div class="content">
					<form id="xzCommNews-infoGridForm" name="xzCommNews-infoGridForm"
						method="post" action="xzCommNews-nb-info-remove.do"
						class="m-form-blank">
						<table id="xzCommNews-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<th class="sorting" name="ffaburen">发布人</th>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr>
										...
										<td>${item.freadnum}</td>
										<td><a href="xzCommNews-nb-info-input.do?id=${item.fid}"
