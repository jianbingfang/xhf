...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.xz-plain-info.list.title" text="月计划 - 工作计划 - 行政管理"/></title>
    <%@include file="/common/s.jsp"%>
    <script type="text/javascript">
var config = {
    id: 'xz-plain-infoGrid',
    pageNo: ${page.pageNo},
	...
	exportUrl: 'xz-plain-info-export.do'
};
	...
	<div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xz-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xz-plain-infoGridForm" name="xz-plain-infoGridForm" method='post' action="xz-plain-info-remove.do" class="m-form-blank">
  <table id="xz-plain-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fstatus}</td>
        <td>
          <a href="xz-plain-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
