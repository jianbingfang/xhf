...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="dev.xzRedTape-wb-info.list.title" text="红头文件（外）- 公司档案管理 - 行政管理" /></title>
...
var config = {
    ...
    params: {
        'filter_LIKES_ftaptitle': '${param.filter_LIKES_ftaptitle}',
         'filter_LIKES_fhjxm': '${param.filter_LIKES_fhjxm}',
         'filter_LIKES_fzj': '${param.filter_LIKES_fzj}',
    },
	selectedItemClass: 'selectedItem',
	gridFormId: 'xzRedTape-wb-infoGridForm',
	exportUrl: 'xzRedTape-wb-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        <header class="header">
		  ...
		  <div class="ctrl">
		    <a class="btn"><i id="xzRedTape-wb-infoSearchIcon" class="icon-chevron-up"></i></a>
		  </div>
		</header>
        <div id="xzRedTape-wb-infoSearch" class="content content-inner">
		  ...
		  <form name="xzRedTape-wb-infoForm" method="post" action="xzRedTape-wb-info-list.do" class="form-inline">
		    ...
		    <input type="text" id="xzRedTape-wb-info_ftaptitle" name="filter_LIKES_ftaptitle" value="${param.filter_LIKES_ftaptitle}">
		    	    <label for="xzRedTape-wb-info_ftaptitle"><spring:message code='xzRedTape-wb-info.xzRedTape-wb-info.list.search.ftaptitle' text='获奖工程名称'/>:</label>
		    <input type="text" id="xzRedTape-wb-info_ftaptitle" name="filter_LIKES_fhjxm" value="${param.filter_LIKES_fhjxm}">
		    	    <label for="xzRedTape-wb-info_ftaptitle"><spring:message code='xzRedTape-wb-info.xzRedTape-wb-info.list.search.ftaptitle' text='获奖人员'/>:</label>
		    <input type="text" id="xzRedTape-wb-info_ftaptitle" name="filter_LIKES_fzj" value="${param.filter_LIKES_fzj}">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="xzRedTape-wb-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='xzRedTape-wb-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="xzRedTape-wb-info.xzRedTape-wb-info.list.title" text="列表"/></h4>
		</header>
        <div class="content">
<form id="xzRedTape-wb-infoGridForm" name="xzRedTape-wb-infoGridForm" method='post' action="xzRedTape-wb-info-remove.do" class="m-form-blank">
  <table id="xzRedTape-wb-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
...
<!--         	<th class="sorting" name="fsend">发文单位</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcode }</td>
      	 	 <td>${item.ftapeno}</td>
      	 	 <td class="span3">${item.ftaptitle}</td>
      	 	  <td class="span2">${item.fhjxm}</td>
      	 	  <td class="span2">${item.fzj }</td>
<%--       	 	 <td>${item.fsend}</td>
      	 	 <td>${item.frecive}</td> --%>
