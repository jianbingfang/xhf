...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="plain-info.plain-info.input.title" text="周计划 - 工作计划 - 行政管理"/></title>
    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="xz-week-plain-info-save.do" class="form-horizontal">
