...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="plain-info.plain-info.input.title" text="月计划 - 工作计划 - 行政管理"/></title>
    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="xz-plain-info-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodulecode" value="xz">
			  ...
			  <div class="control-group">
				...
				<div class="controls">
				 	<input id="plain-info_fmonth" type="text" name="fmonth" value="${model.fmonth}" size="40"
						   class="text required" minlength="" maxlength="6">
			    </div>
			  </div>
			  <div class="control-group">
