    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="wzIo-infoSearch" class="content content-inner">
		  ...
		  <label for="wzIo-info_fwzbm"><spring:message code='wzIo-info.wzIo-info.list.search.fcode' text='物资编码'/>:</label>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="wzIo-infoGridForm" name="wzIo-infoGridForm" method='post' action="wzIo-info-remove.do" class="m-form-blank">
...
<%--       	 	 <td>${item.fmemo}</td>
      	 	 ...
      	 	 <td>${item.fmemo2}</td> --%>
        <td>
          <a href="wzIo-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
