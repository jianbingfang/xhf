...
<%pageContext.setAttribute("currentMenu", "xz-cbhs");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'xz-doc-cbhs-infoGridForm',
	exportUrl: 'xz-doc-cbhs-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xz-doc-cbhs-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xz-doc-cbhs-infoGridForm" name="xz-doc-cbhs-infoGridForm" method='post' action="xz-doc-cbhs-remove.do" class="m-form-blank">
  <table id="xz-doc-cbhs-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
      ...
      <tr>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
          <td>${item.fmemo}</td>
        <td>
          <a href="xz-doc-cbhs-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
