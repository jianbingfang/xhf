					...
					<form id="wzList-infoForm" method="post"
						...
						<div class="control-group">
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="wzList-info_flyr" type="text" name="flyr"   readonly
							...
							<div class="span5">
								...
								<div class="controls">
									<!-- <div class="input-append datepicker date"
										...
										<input id="wzList-info_flydate" type="text" name="flydate" readonly
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
										<input id="wzList-info_fxmid" type="hidden" name="fxmid"
									value="${model.fxmid}"> <input
									id="wzList-info_fxmidmc" type="text" value="${xmMap[model.fxmid].fxmname}" disabled
									class=" required"  value=""> 
								</div>
							</div>
							<div class="span5">
								<label class="control-label" for="wzList-info_fxmid"><spring:message
										code="wzList-info.wzList-info.input.fxmidry" text="负责人" /></label>
								<div class="controls">
								 <input
										id="ryBxRecord-info_userName" type="text" value="${ryMap[xmMap[model.fxmid].fxmzongjianid].fname}"
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="wzList-info_fxjstate" type="text" name="fxjstate"
										value="${model.fxjstate}" size="" class="text "
										minlength="" maxlength="">
								</div>
							</div>
						</div>
							...
							<div class="span5 hidden">
								...
								<div class="controls">
								     <input id="wzList-info_ftype" type="text" name="ftype"
										value="1" size="" class="text required" minlength=""
										maxlength="">
								</div>
							</div>
						<div class="control-group">
