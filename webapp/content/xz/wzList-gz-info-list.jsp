        ...
        <article class="m-widget">
            ...
            <div id="wzList-infoSearch" class="content content-inner">
                <form name="wzList-infoForm" method="post"
                    ...
                    <input type="text" id="wzList-info_fcode" style="width: 150px;"
                    ...
                    <input type="text" id="wzList-info_fname" style="width: 150px;"
                    ...
                    <label for="wzList-info_fprojectname"><spring:message
                            ...
                            text='项目名称'/>:</label> <input type="text" style="width: 150px;"
                    ...
                    <input type="text" id="wzList-info_flyr" style="width: 150px;"
