...
<title><spring:message
		code="xzCommNews-info.xzCommNews-info.input.title"
...
<script type="text/javascript">
	$(function() {
		...
		var editor = CKEDITOR.replace('xzCommNews-info_fnewcontent');
	...
	<div class="row-fluid">
		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="xzCommNews-info.xzCommNews-info.input.title"
							text="编辑" />
					</h4>
				</header>
				...
				<div class="content content-inner">
					...
					<form id="xzCommNews-infoForm" method="post"
						action="xzCommNews-info-save.do" class="form-horizontal">
						<c:if test="${model != null}">
							<input id="xzCommNews-info_id" type="hidden" name="fid"
								value="${model.fid}">
						</c:if>
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_fname"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.fname" text="新闻标题" /></label>
								<div class="controls">
									<input id="xzCommNews-info_fname" type="text" name="fname"
							...
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_freadnum"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.freadnum"
										text="阅读次数" /></label>
								<div class="controls">
									<input id="xzCommNews-info_freadnum" type="number"
										name="freadnum" value="${model.freadnum}" size=""
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_froles"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.froles"
										text="访问权限" /></label>
								<div class="controls">
							...
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_fitop"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.fitop" text="是否置顶" /></label>
								<div class="controls">
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_ffaburen"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.ffaburen"
										text="发布单位" /></label>
								<div class="controls">
									<input id="xzCommNews-info_ffaburen" type="text"
										name="ffaburen" value="${model.ffaburen}" size=""
										class="text " minlength="" maxlength="">
								</div>
							</div>

							<div class="span5">
								<label class="control-label" for="xzCommNews-info_ftuijian"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.ftuijian"
										text="是否推荐" /></label>
								<div class="controls">
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_forder"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.forder" text="排序" /></label>
								<div class="controls">
							...
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_fcreatedate"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.fcreatedate"
										text="发布时间" /></label>
								<div class="controls">
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="xzCommNews-info_fupdatedate"><spring:message
										code="xzCommNews-info.xzCommNews-info.input.fupdatedate"
										text="更新时间" /></label>
								<div class="controls">
									<div class="input-append datetimepicker date"
										style="padding-left: 0px;">
						...
						<div class="control-group">
							<label class="control-label" for="xzCommNews-info_fnewcontent"><spring:message
									code="xzCommNews-info.xzCommNews-info.input.fnewcontent"
									text="新闻内容" /></label>
							<div class="controls">
								<textarea id="xzCommNews-info_fnewcontent" name="fnewcontent"
						...
						<div class="control-group">
							<label class="control-label" for="xzCommNews-info_furl"><spring:message
									code="xzCommNews-info.xzCommNews-info.input.furl" text="网页链接" /></label>
							<div class="controls">
								<textarea id="xzCommNews-info_furl" name="furl"
									class="form-control" rows="4" style="width: 560px"
									class="text  " minlength="" maxlength="512">${model.furl}</textarea>
							</div>
						</div>
