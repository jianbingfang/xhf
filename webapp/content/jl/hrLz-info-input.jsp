...
<%--     	<div class="span5">
		...
		<div class="controls">
			 <textarea id="jl-hrLz-info_freason"  name="freason"  class="form-control" rows="6"  style="width: 560px" class="text "  minlength="20" maxlength="500">${model.freason}</textarea>
	    </div>
	  </div>
    	<div class="control-group">
		...
		<div class="controls">
		   <textarea id="jl-hrLz-info_fczbg"  name="fczbg"  class="form-control" rows="6"  style="width: 560px" class="text "  minlength="20" maxlength="500">${model.fczbg}</textarea>
	    </div>
	  </div>
    	<div class="control-group">
	    <label class="control-label" for="jl-hrLz-info_fjy"><spring:message code="jl-hrLz-info.jl-hrLz-info.input.fjy" text="对公司建议"/></label>
		<div class="controls">
			<textarea id="jl-hrLz-info_fjy"  name="fjy"  class="form-control" rows="6"  style="width: 560px" class="text "  minlength="20" maxlength="500">${model.fjy}</textarea>
	    </div>
	  </div>
