    ...
    <div class="row-fluid">
      ...
      <section id="m-main" class="span10">
			<ul id="myTab" class="nav nav-tabs" role="tablist">
			  <li role="presentation" class="active"><a href="#tab1">项目进度</a></li>
			  <li role="presentation" ><a href="#tab2">项目现场实况</a></li>
			  <li role="presentation" ><a href="#tab3">监理部实况</a></li>
			</ul>
			
			<div class="tab-content">
			  	<div class="tab-pane active" id="tab1">
			  	 	<iframe  src="jlXgdw-info-list.do" height="600px" width="100%"  style="border: 0px;"></iframe>
				</div>
			  	<div class="tab-pane" id="tab2">
			  		<iframe  src="jl-sq-jdimg-info.do" height="600px" width="100%"  style="border: 0px;"></iframe>
			  	</div>  
			  	<div class="tab-pane" id="tab3">
			  		<iframe  src="jl-sq-jlbimg-info.do" height="600px" width="100%"  style="border: 0px;"></iframe>
			  	</div> 
			</div>
      </section>
	</div>
