...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
            ...
            <div class="pull-left">
                <region:region-permission permission="jlXgdw-info:create">
                    <button class="btn btn-small a-insert"
                            onclick="location.href='jlXgdw-info-input.do?dwType=${dwType}'">新建
                    </button>
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="jlXgdw-infoGridForm" name="jlXgdw-infoGridForm" method='post' action="jlXgdw-info-remove.do"
                      class="m-form-blank">
                    <table id="jlXgdw-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td>${item.fmemo}</td>
                                <td>
                                    <a href="jlXgdw-info-input.do?id=${item.fid}&dwType=${dwType}"
