...
<!-- <div class="container-fluid">
	<div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="jl-hrLz-infoSearch" class="content content-inner">
		  ...
		  <form name="jl-hrLz-infoForm" method="post" action="jl-hrLz-info-list.do" class="form-inline">
		    <label for="jl-hrLz-info_name"><spring:message code='jl-hrLz-info.jl-hrLz-info.list.search.name' text='申请人'/>:</label>
		    <input type="text" id="jl-hrLz-info_name" name="filter_LIKES_fmemo1" value="${param.filter_LIKES_fmemo1}">
		   ...
		   <div class="input-append datepicker date" style="padding-left: 0px;">
		    <input id="commRy-info_ruzhi" type="text" name="filter_LTD_fstartdate" value="${param.filter_LTD_fstartdate}" size="40" class="text "  style="background-color:white;cursor:default; width: 160px;">
		    <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
		  </div>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jl-hrLz-infoGridForm" name="jl-hrLz-infoGridForm" method='post' action="jl-hrLz-info-remove.do" class="m-form-blank">
  <table id="jl-hrLz-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="jl-hrLz-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
