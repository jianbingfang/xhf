    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="jl-doc-gzlc-save.do" class="form-horizontal">
			  ...
			  <div class="control-group">
			   ...
			   <div class="control-group">
				...
				<div class="controls">
					<input id="plain-info_creator" type="text" name="fcreator" value="${model.fcreator}" size="40" class="text " minlength="1" maxlength="50">
			    </div>
			  </div>
			     <div class="control-group">
