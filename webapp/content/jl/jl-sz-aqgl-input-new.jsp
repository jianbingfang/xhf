...
$(function() {
    ...
    $('#myTab a').click(function (e) {
    	  ...
    	  $(contentId + " iframe").attr("src","jlShiZhongNew-info-listUserDefined.do?defineCode="+$(this).attr('code'));
    });
    ...
    <div class="row-fluid">
      ...
      <section id="m-main" class="span10">
		<ul id="myTab" class="nav nav-tabs" role="tablist">
			<c:forEach items="${aqList}" var="item">
				<li role="presentation"><a href="#tab${item.fid}" code="${item.fid}">${item.fname}</a></li>
			</c:forEach>
		</ul>
