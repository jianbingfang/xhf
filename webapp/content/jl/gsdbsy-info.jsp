    ...
    <div class="row-fluid">
      ...
      <section id="m-main" class="span10">
			<ul id="myTab" class="nav  nav-pills nav-stacked" role="tablist" style="float:left;">
			  <li role="presentation" class="active" ><a href="#tab1">固定资产</a></li>
			  <li role="presentation"><a href="#tab2">低值易耗品</a></li>
			  <li role="presentation"><a href="#tab3">消耗品</a></li>
			</ul>
			
			<div class="tab-content">
			  	<div class="tab-pane active" id="tab1">
			  	 	<iframe  src="../xz/wzTable-info-list.do" height="600px" width="100%"  style="border: 0px;"></iframe>
				</div>
