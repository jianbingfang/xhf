	...
	<div class="row-fluid">
		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="pjXm-info.pjXm-info.input.title" text="项目信息" />
					</h4>
				</header>
				<div class="content content-inner">
					<form id="pjXm-infoForm" method="post" action="jl-pjXm-info-save.do"
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="pjXm-info_fxmname" type="text" name="fxmname"
										style="width: 400px" value="${model.fxmname}" size=""
							...
							<div class="span5">
								...
								<div class="controls">
									<select class="form-control" id="pjXm-info_fxmstatus"
										...
										<option value="待建"
											<c:if test="${model.fxmstatus=='待建'}"> selected="selected"  </c:if>>待建</option>
									</select>
								</div>
							</div>
							<div class="span5">
							...
							<div class="span5">
								...
								<div class="controls">
									<select id="pjXm-info_fprovince" type="text"
														...
														id="pjXm-info_fcity" type="text" name="fcity"
														value="${model.fcity}" style="width:100px;"></select>市 <input
										id="pjXm-info_fxmaddr" type="text" name="fxmaddr"
						...
						<div class="control-group">
							...
							<div class="span5">
								<label class="control-label" for="pjXm-info_fjzgm"><spring:message
										code="pjXm-info.pjXm-info.input.fxmstatus" text="建设规模" /></label>
								<div class="controls">
