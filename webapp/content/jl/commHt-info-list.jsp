...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="dev.jl-commHt-info.list.title" text="列表" /></title>
...
var config = {
	...
	gridFormId: 'jl-commHt-infoGridForm',
	exportUrl: 'jl-commHt-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        <header class="header">
		  ...
		  <div class="ctrl">
		    <a class="btn"><i id="jl-commHt-infoSearchIcon" class="icon-chevron-up"></i></a>
		  </div>
		</header>
        <div id="jl-commHt-infoSearch" class="content content-inner">

		  <form name="jl-commHt-infoForm" method="post" action="jl-commHt-info-list.do" class="form-inline">
		    <label for="jl-commHt-info_name"><spring:message code='jl-commHt-info.jl-commHt-info.list.search.name' text='名称'/>:</label>
		    <input type="text" id="jl-commHt-info_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}">
			<button class="btn btn-small a-search" onclick="document.jl-commHt-infoForm.submit()">查询</button>&nbsp;
		  </form>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  <region:region-permission permission="jl-commHt-info:create">
		  <button class="btn btn-small a-insert" onclick="location.href='jl-commHt-info-input.do'">新建</button>
		  </region:region-permission>
		  <region:region-permission permission="jl-commHt-info:delete">
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="jl-commHt-info.jl-commHt-info.list.title" text="列表"/></h4>
		</header>
        <div class="content">
<form id="jl-commHt-infoGridForm" name="jl-commHt-infoGridForm" method='post' action="jl-commHt-info-remove.do" class="m-form-blank">
  <table id="jl-commHt-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
      ...
      <!--   	<th class="sorting" name="fscale">工程规模</th>
        	...
        	<th class="sorting" name="fprojectname">工程名称</th>
        	...
        	<th class="sorting" name="fyezhuname">业主名称</th>
        ...
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	...
      	<%--  	 <td>${item.fhetongno}</td>
      	 ...
      	 <%-- 	 <td>${item.fqiandingstatus}</td>
      	 	 ...
      	 	 <td>${item.fzongjian}</td>
        <td>
          <a href="jl-commHt-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
