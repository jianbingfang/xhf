    ...
    <div class="row-fluid">
      ...
      <section id="m-main" class="span10">
			<ul id="myTab" class="nav nav-tabs" role="tablist">
			  <li role="presentation" class="active"><a href="#tab1" sz-type="TEMP_JL_HTSJJTZ">合同收集及台账</a></li>
			  <li role="presentation" class=""><a href="#tab2" sz-type="TEMP_JL_HTYQJGCYW">工程延期及工程延误</a></li>
			  <li role="presentation" class=""><a href="#tab3" sz-type="TEMP_JL_SGHTJC">施工合同解除</a></li>
			   <li role="presentation" class=""><a href="#tab4" sz-type="TEMP_JL_SGHTZYJJ">施工合同争议解决</a></li>
			</ul>
			
			<div class="tab-content">
			  <div class="tab-pane active" id="tab1">
			 	 <iframe  src="jlShizhong-info-list.do?fszleix=TEMP_JL_HTSJJTZ" height="600px" width="100%"  style="border: 0px;"></iframe>
				</div>
