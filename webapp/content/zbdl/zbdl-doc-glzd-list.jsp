...
<%pageContext.setAttribute("currentMenu", "zbdl-zd");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'zbdl-doc-glzd-infoGridForm',
	exportUrl: 'zbdl-doc-glzd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="zbdl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="zbdl-plain-infoForm" method="post" action="zbdl-doc-glzd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='zbdl-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="zbdl-doc-glzd-infoGridForm" name="zbdl-doc-glzd-infoGridForm" method='post' action="zbdl-doc-glzd-remove.do" class="m-form-blank">
  <table id="zbdl-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="zbdl-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
