...
var config = {
	...
	gridFormId: 'zbdl-doc-gzlc-infoGridForm',
	exportUrl: 'zbdl-doc-gzlc-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="zbdl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="zbdl-plain-infoForm" method="post" action="zbdl-doc-gzlc-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='zbdl-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="zbdl-doc-gzlc-infoGridForm" name="zbdl-doc-gzlc-infoGridForm" method='post' action="zbdl-doc-gzlc-remove.do" class="m-form-blank">
  <table id="zbdl-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="zbdl-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
