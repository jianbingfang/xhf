...
<form id="hd-infoForm" method="post" action="gh-hd-info-save.do?ftype=3" class="form-horizontal">
  <c:if test="${model != null}">
	  ...
	  <div class="span5">
						...
						<div class="span5">
					    <label class="control-label" for="hd-info_fpxnr"><spring:message code="hd-info.hd-info.input.fpxnr" text="内容"/></label>
						<div class="controls">
