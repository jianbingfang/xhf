...
$(function() {
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="hd-infoSearch" class="content content-inner">
			  ...
			  <form name="hd-infoForm" method="post" action="gh-hd-info-list.do?ftype=1" class="form-inline">
 ...
 <button class="btn btn-small a-insert" onclick="location.href='gh-hd-info-input.do?ftype=1'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="hd-infoGridForm" name="hd-infoGridForm" method='post' action="gh-hd-info-remove.do?ftype=1" class="m-form-blank">
  <table id="hd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
        <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
        	<th class="sorting" name="fpxzt">会议主题</th>
