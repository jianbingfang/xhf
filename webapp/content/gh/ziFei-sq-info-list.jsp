    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="ziFei-infoSearch" class="content content-inner">
		  ...
		  <form name="ziFei-infoForm" method="post" action="ziFei-info-list.do?ftype=3" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='ziFei-info-input.do?ftype=3'">新建</button>
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fjsren}</td>
        <td>
          <a href="ziFei-info-input.do?ftype=3&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
