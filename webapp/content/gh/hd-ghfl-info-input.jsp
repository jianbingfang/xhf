...
<form id="hd-infoForm" method="post" action="gh-hd-info-save.do?ftype=2" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="hd-info_id" type="hidden" name="fid" value="${model.fid}">
						...
						<div class="span5">
					    <label class="control-label" for="hd-info_fpxzt"><spring:message code="hd-info.hd-info.input.fpxzt" text="主题"/></label>
						<div class="controls">
						...
						<div class="control-group">
						<div class="span5">
					    <label class="control-label" for="hd-info_fcjry"><spring:message code="hd-info.hd-info.input.fcjry" text="惠及人员"/></label>
						<div class="controls">
							  	 <input id="hd-info_fcjry" type="text" name="fcjry" value="${model.fcjry}" size="" class="text " minlength="" maxlength="">	
					    </div>
					  </div>
	  
				<%-- 		<div class="span5">
					    <label class="control-label" for="hd-info_fpxnr"><spring:message code="hd-info.hd-info.input.fpxnr" text="培训内容"/></label>
						<div class="controls">
