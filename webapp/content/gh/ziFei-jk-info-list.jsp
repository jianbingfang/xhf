    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="ziFei-infoSearch" class="content content-inner">
		  ...
		  <form name="ziFei-infoForm" method="post" action="ziFei-info-list.do?ftype=2" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='ziFei-info-input.do?ftype=2'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="ziFei-infoGridForm" name="ziFei-infoGridForm" method='post' action="ziFei-info-remove.do?ftype=2" class="m-form-blank">
    ...
    <thead>
      <tr>
        <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
        	...
        	<th class="sorting" name="fjqren">捐款人</th>
        <th width="80">&nbsp;</th>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fjqren}</td>
        <td>
          <a href="ziFei-info-input.do?ftype=2&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
