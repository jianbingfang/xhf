...
var config = {
	...
	exportUrl: 'hd-info-export.do?ftype=2'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="hd-infoSearch" class="content content-inner">
		  	  ...
		  	  <form name="hd-infoForm" method="post" action="gh-hd-info-list.do?ftype=2" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gh-hd-info-input.do?ftype=2'">新建</button>
...
<form id="hd-infoGridForm" name="hd-infoGridForm" method='post' action="gh-hd-info-remove.do?ftype=2" class="m-form-blank">
 ...
 <%--      	 	 <td>${item.faddress}</td>
      	 	 ...
      	 	 <td>${item.fmemo2}</td> --%>
        <td>
          <a href="hd-info-input.do?ftype=2&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
