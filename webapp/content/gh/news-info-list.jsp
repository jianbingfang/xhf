...
var config = {
	...
	exportUrl: 'news-info-export.do?ftype=${param.ftype}'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="news-infoSearch" class="content content-inner">
		  ...
		  <form name="news-infoForm" method="post" action="gh-news-info-list.do?ftype=3" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gh-news-info-input.do?ftype=3'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="news-infoGridForm" name="news-infoGridForm" method='post' action="news-info-remove.do" class="m-form-blank">
    ...
    <thead>
      <tr>
        <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
        	...
        	<!-- <th class="sorting" name="fmemo">正文</th> -->
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fmemo2}</td> --%>
        <td>
          <a href="news-info-input.do?ftype=${param.ftype}&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
