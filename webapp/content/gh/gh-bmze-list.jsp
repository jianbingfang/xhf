    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gh-doc-bmze-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cw-doc-glzd-infoGridForm" name="cw-doc-glzd-infoGridForm" method='post' action="gh-doc-bmze-remove.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
        <td>
          <a href="gh-doc-bmze-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
      <%--   <td>${item.fmemo}</td> --%>
      </tr>
      </c:forEach>
