...
var config = {
	...
	exportUrl: 'news-info-export.do?ftype=4'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="news-infoSearch" class="content content-inner">
		  ...
		  <form name="news-infoForm" method="post" action="gh-news-info-list.do?ftype=4" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gh-news-info-input.do?ftype=4'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="news-infoGridForm" name="news-infoGridForm" method='post' action="gh-news-info-remove.do?ftype=4" class="m-form-blank">
  <table id="news-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
     ...
     <%--  	 	 <td>${item.fmemo}</td>
      	 	 ...
      	 	 <td>${item.fmemo2}</td> --%>
        <td>
          <a href="news-info-input.do?ftype=4&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
