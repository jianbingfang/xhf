...
<form id="ziFei-infoForm" method="post" action="ziFei-info-save.do?ftype=3" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="ziFei-info_id" type="hidden" name="fid" value="${model.fid}">
						...
						<div class="span5">
					    <label class="control-label" for="ziFei-info_fno"><spring:message code="ziFei-info.ziFei-info.input.fno" text="申请单号"/></label>
						<div class="controls">
						...
						<div class="control-group">
						<div class="span5">
					    <label class="control-label" for="ziFei-info_fjsren"><spring:message code="ziFei-info.ziFei-info.input.fjsren" text="申请人"/></label>
						<div class="controls">
							  	<input id="ziFei-info_fjsren" type="text" name="fjsren" value="${model.fjsren}" size="" class="number   " minlength="" maxlength="">
					    </div>
					  </div>
						...
						<div class="controls">
							  	<input id="ziFei-info_fjqren" type="text" name="fjqren" value="${model.fjqren}" size="" class="number   " minlength="" maxlength="">
					    </div>
					    </div> --%>
					    </div>
