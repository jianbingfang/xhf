...
<form id="news-infoForm" method="post" action="gh-news-info-sava.do?ftype=3" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="news-info_id" type="hidden" name="fid" value="${model.fid}">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="news-info_ffwdw"><spring:message code="news-info.news-info.input.ffwdw" text="发文单位"/></label>
					<div class="controls">
					  	 <input id="news-info_ffwdw" type="text" name="ffwdw" value="${model.ffwdw}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
			    	<div class="control-group">
					...
					<div class="controls">
				      	<textarea id="news-info_fmemo"  name="fmemo"  class="form-control" rows="6"  style="width: 560px" class="text  "  minlength="" maxlength="2000">${model.fmemo}</textarea>
				    </div>
				  </div>
			 <%--    	<div class="control-group">
