...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="cwZc-infoSearch" class="content content-inner">
                ...
                <form name="cwZc-infoForm" method="post" action="cwZc-info-list.do" class="form-inline">
                    <label for="cwZc-info_name"><spring:message code='cwZc-info.cwZc-info.list.search.name'
                                                                text='名称'/>:</label>
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="cwZc-infoGridForm" name="cwZc-infoGridForm" method='post' action="cwZc-info-remove.do"
                      class="m-form-blank">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                <td><input type="checkbox" class="selectedItem a-check" name="selectedItem"
                                           value="${item.fid}"></td>
                                <td><a href="cwZc-info-input.do?id=${item.fid}" class="a-update"><spring:message
