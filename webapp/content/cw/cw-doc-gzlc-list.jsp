...
var config = {
	...
	gridFormId: 'cw-doc-gzlc-infoGridForm',
	exportUrl: 'cw-doc-gzlc-export.do'
};
	...
	<!-- <div class="container-fluid">
	 ...
	 <%--  <article class="m-widget">
        ...
        <div id="cw-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="cw-plain-infoForm" method="post" action="cw-doc-gzlc-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='cw-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cw-doc-gzlc-infoGridForm" name="cw-doc-gzlc-infoGridForm" method='post' action="cw-doc-gzlc-remove.do" class="m-form-blank">
  <table id="cw-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
       ...
       <%-- <td>${item.fstartdate}</td>
        ...
        <td>${item.fcreator}</td> --%>
        <td>
          <a href="cw-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
