...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="cw-doc-gzlc-infoGridForm" name="cw-doc-gzlc-infoGridForm" method='post'
                      action="cw-doc-gzlc-remove.do" class="m-form-blank">
                    <table id="cw-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td>${item.fmemo}</td>
                                <td>
                                    <a href="cw-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message
