...
<title><spring:message code="dev.cwcb-info.list.title" text="列表" /></title>
...
<script type="text/javascript">
	var config = {
		...
		gridFormId : 'cwcb-infoGridForm',
		exportUrl : 'cwcb-info-export.do'
	};
		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				<header class="header">
					...
					<div class="ctrl">
						<a class="btn"><i id="cwcb-infoSearchIcon"
							class="icon-chevron-up"></i></a>
					</div>
				</header>
				<div id="cwcb-infoSearch" class="content content-inner">
					<form name="cwcb-infoForm" method="post" action="cwcb-info-list.do"
						class="form-inline">
						...
						<button class="btn btn-small a-search"
							onclick="document.cwcb-infoForm.submit()">查询</button>
						&nbsp;
					</form>
				</div>
			</article>
			<article class="m-blank">
				<div class="pull-left">
					<region:region-permission permission="cwcb-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='cwcb-info-input.do'">新建</button>
					</region:region-permission>
					<region:region-permission permission="cwcb-info:delete">
			...
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="cwcb-info.cwcb-info.list.title" text="列表" />
					</h4>
				</header>
				<div class="content">
					<form id="cwcb-infoGridForm" name="cwcb-infoGridForm" method='post'
						action="cwcb-info-remove.do" class="m-form-blank">
						<table id="cwcb-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<th class="sorting" name="fchengben">金额</th>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr>
										...
										<td>${item.fchengben}</td>
										<td>${item.fdate}</td>
										<td>${item.fmemo}</td>
										<td><a href="cwcb-info-input.do?id=${item.fid}"
