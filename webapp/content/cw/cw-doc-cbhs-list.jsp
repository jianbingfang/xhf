...
<%pageContext.setAttribute("currentMenu", "cw-cbhs");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'cw-doc-cbhs-infoGridForm',
	exportUrl: 'cw-doc-cbhs-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='cw-doc-cbhs-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cw-doc-cbhs-infoGridForm" name="cw-doc-cbhs-infoGridForm" method='post' action="cw-doc-cbhs-remove.do" class="m-form-blank">
  <table id="cw-doc-cbhs-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
        <td>
          <a href="cw-doc-cbhs-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
