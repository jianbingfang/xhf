...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="cwHtfx-infoSearch" class="content content-inner">

                <form name="cwHtfx-infoForm" method="post" action="cwHtfx-info-list.do" class="form-inline">
                    <label for="cwHtfx-info_fhetongname"><spring:message
                            code='cwHtfx-info.cwHtfx-info.list.search.fhetongname' text='合同名称'/>:</label>
                    <input type="text" id="cwHtfx-info_fhetongname" name="filter_LIKES_fhetongname"
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="cwHtfx-infoGridForm" name="cwHtfx-infoGridForm" method='post' action="cwHtfx-info-remove.do"
                      class="m-form-blank">
                    <table id="cwHtfx-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td>${item.fmemo}</td>
                                <td>
                                    <a href="cwHtfx-info-input.do?id=${item.fid}" class="a-update"><spring:message
