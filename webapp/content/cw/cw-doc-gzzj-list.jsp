...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="cw-doc-gzzj-infoGridForm" name="cw-doc-gzzj-infoGridForm" method='post'
                      action="cw-doc-gzzj-remove.do" class="m-form-blank">
                    <table id="cw-doc-gzzj-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item">
                            <tr>
                                ...
                                <td>${item.fmemo}</td>
                                <td>
                                    <a href="cw-doc-gzzj-input.do?id=${item.fid}" class="a-update"><spring:message
