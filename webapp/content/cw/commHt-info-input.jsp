        ...
        <article class="m-widget">
            ...
            <div class="content content-inner">
                <form id="commHt-infoForm" method="post"
                      action="cw-commHt-info-saveinput.do" class="form-horizontal">
                        ...
                        <div class="span5">
                            ...
                            <div class="controls">
                                <select class="form-control" id="jyXm-info_fqiandingstatus"
                                        name="fqiandingstatus" required
                                        >
                                    <option value=""></option>
                                    <option value="2"
                                            <c:if test="${model.fqiandingstatus=='2'}"> selected="selected" </c:if>>合同谈判
                                    </option>
                                    <option value="4"
                                            <c:if test="${model.fqiandingstatus=='4'}"> selected="selected" </c:if>>业主签章
                                    </option>
                                    <option value="5"
                                            <c:if test="${model.fqiandingstatus=='5'}"> selected="selected" </c:if>>返还归档
                                    </option>
                                </select>
                        ...
                        <div class="span5">
                            ...
                            <div class="controls">
                                <select class="form-control" id="jyXm-info_fprojecttype"
                                        ...
                                        class=" required">
                                    <option value="房屋建筑工程"
                                            <c:if test="${model.fprojecttype=='房屋建筑工程'}"> selected="selected" </c:if>>
                                        房屋建筑工程
                                    </option>
                                    <option value="市政公用工程"
                                            <c:if test="${model.fprojecttype=='市政公用工程'}"> selected="selected" </c:if>>
                                        市政公用工程
                                    </option>
                                    <option value="电力工程"
                                            <c:if test="${model.fprojecttype=='电力工程'}"> selected="selected" </c:if>>电力工程
                                    </option>
                                    <option value="冶炼工程"
                                            <c:if test="${model.fprojecttype=='冶炼工程'}"> selected="selected" </c:if>>冶炼工程
                                    </option>
                                    <option value="公路工程"
                                            <c:if test="${model.fprojecttype=='公路工程'}"> selected="selected" </c:if>>公路工程
                                    </option>
                                    <option value="矿山工程"
                                            <c:if test="${model.fprojecttype=='矿山工程'}"> selected="selected" </c:if>>矿山工程
                                    </option>
                                    <option value="化工石油工程"
                                            <c:if test="${model.fprojecttype=='化工石油工程'}"> selected="selected" </c:if>>
                                        化工石油工程
                                    </option>
                                    <option value="水利水电工程"
                                            <c:if test="${model.fprojecttype=='水利水电工程'}"> selected="selected" </c:if>>
                                        水利水电工程
                                    </option>
                                    <option value="农林工程"
                                            <c:if test="${model.fprojecttype=='农林工程'}"> selected="selected" </c:if>>农林工程
                                    </option>
                                    <option value="铁路工程"
                                            <c:if test="${model.fprojecttype=='铁路工程'}"> selected="selected" </c:if>>铁路工程
                                    </option>
                                    <option value="港口与航道工程"
                                            <c:if test="${model.fprojecttype=='港口与航道工程'}"> selected="selected" </c:if>>
                                        港口与航道工程
                                    </option>
                                    <option value="航天航空工程"
                                            <c:if test="${model.fprojecttype=='航天航空工程'}"> selected="selected" </c:if>>
                                        航天航空工程
                                    </option>
                                    <option value="通信工程"
                                            <c:if test="${model.fprojecttype=='通信工程'}"> selected="selected" </c:if>>通信工程
                                    </option>
                                    <option value="机电安装工程"
                                            <c:if test="${model.fprojecttype=='机电安装工程'}"> selected="selected" </c:if>>
                                        机电安装工程
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="span5">
                            ...
                            <div class="controls">
                                <select class="form-control" id="commHt-info_fywtype"
                                    ...
                                    <option value="工程监理"
                                            <c:if test="${model.fywtype=='工程监理'}"> selected="selected" </c:if>>工程监理
                                    </option>
                                    <option value="项目管理"
                                            <c:if test="${model.fywtype=='项目管理'}"> selected="selected" </c:if>>项目管理
                                    </option>
                                    <option value="招标代理"
                                            <c:if test="${model.fywtype=='招标代理'}"> selected="selected" </c:if>>招标代理
                                    </option>
                                    <option value="造价咨询"
                                            <c:if test="${model.fywtype=='造价咨询'}"> selected="selected" </c:if>>造价咨询
                                    </option>
                                    <option value="勘探设计"
                                            <c:if test="${model.fywtype=='勘探设计'}"> selected="selected" </c:if>>勘探设计
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="span5">
                            ...
                            <div class="controls">
                                <select id="commHt-info_fjsstate" name="fjsstate" size=""
                                        class="text ">
                                    <option value="未结算"
                                            <c:if test="${model.fjsstate=='未结算' }">selected="selected"</c:if>>未结算
                                    </option>
                                    <option value="已结算"
                                            <c:if test="${model.fjsstate=='已结算' }">selected="selected"</c:if>>已结算
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="control-group">
                        <div class="span5">
                            <label class="control-label" for="commHt-info_fzkcns"><spring:message
                                    code="commHt-info.commHt-info.input.fzjcns" text="总监承诺书"/></label>

                            <div class="controls">
                                <select class="form-control" id="jyXm-info_fzjcns"
                                        name="fzjcns" required>
                                    <option value=""></option>
                                    <option value="未签订"
                                            <c:if test="${model.fzjcns=='未签订'}"> selected="selected" </c:if>>未签订
                                    </option>
                                    <option value="已签订"
                                            <c:if test="${model.fzjcns=='已签订'}"> selected="selected" </c:if>>已签订
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="span5">
                            <label class="control-label" for="commHt-info_fmbzrs"><spring:message
                                    code="commHt-info.commHt-info.input.fmbzrs" text="目标责任书"/></label>

                            <div class="controls">
                                <select id="commHt-info_fmbzrs" name="fmbzrs" size=""
                                        class="text ">
                                    <option value=""></option>
                                    <option value="未签订"
                                            <c:if test="${model.fmbzrs=='未签订' }">selected="selected"</c:if>>未签订
                                    </option>
                                    <option value="已签订"
                                            <c:if test="${model.fmbzrs=='已签订' }">selected="selected"</c:if>>已签订
                                    </option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="submit" class="btn a-submit"
                                    formaction="cw-commHt-info-save.do">
                                <spring:message code='core.input.save' text='保存并返回菜单'/>
                            </button>
                            &nbsp;
                            <button type="submit" class="btn a-submit">
                                <spring:message code='core.input.saveinput' text='保存并添加'/>
                            </button>
                            &nbsp;
