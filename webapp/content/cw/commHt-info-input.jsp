							...
							<div class="span5">
								...
								<div class="controls">
										...
										name="fzjcns" required>
											<option value="" ></option>
											<option value="未签订"
											<c:if test="${model.fzjcns=='未签订'}"> selected="selected"  </c:if>>未签订 </option>
											<option value="已签订"
											<c:if test="${model.fzjcns=='已签订'}"> selected="selected"  </c:if>>已签订</option>
									</select>	
								</div>
							</div>
							<div class="span5">
								...
								<div class="controls">
									<select id="commHt-info_fmbzrs" name="fmbzrs" size=""
										...
										<option value="" ></option>
										<option value="未签订"
											<c:if test="${model.fmbzrs=='未签订' }">selected="selected"</c:if>>未签订</option>
										<option value="已签订"
											<c:if test="${model.fmbzrs=='已签订' }">selected="selected"</c:if>>已签订</option>
									</select>
								</div>
							</div>
						</div>
