        ...
        $(
                function () {
                    $("#cwBzj-info_fjnbksmoney").change(function () {
                        ...
                        System.out.println("#cwBzj-info_fjnmoney Value", $("#cwBzj-info_fjnmoney").value);
                            ...
                            <div class="input-append htPicker">
                                <input id="cwBzj-info_fxmid" type="hidden" name="fxmid"
                                       value="${model.fxmid}"> <input id="cwBzj-info_xmmc"
                                                                      type="text" disabled
                                                                      value="${htMap[model.fxmid].fhtname}"
                    ...
                    <div class="control-group">
                        <div class="span5">
                            ...
                            <fieldset style="width:200px;">
                                <legend style="width: 280px; margin-left: -80px;padding-left: -40 px;">金额统计</legend>
