...
<title><spring:message code="dev.cw-commHt-info.list.title"
		text="列表" /></title>
		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				<header class="header">
					...
					<div class="ctrl">
						<a class="btn"><i id="cw-commHt-infoSearchIcon"
							class="icon-chevron-up"></i></a>
					</div>
				</header>
				<div id="cw-commHt-infoSearch" class="content content-inner">
					<form name="cw-commHt-infoForm" method="post"
						action="cw-commHt-info-list.do?state=${state }" class="form-inline">
						<label for="xz-commHt-info_fhetongno"><spring:message
						...
						</select>&nbsp; <label for="cwYingShou-info_fdzdate"><spring:message
								code='cwYingShou-info.cwYingShou-info.list.search.fdzdate'
							...
							for="cwYingShou-info_fdzdate"><spring:message
								code='cwYingShou-info.cwYingShou-info.list.search.fdzdate'
								text='开工时间' />:</label>
						<div class="input-append datepicker date"
							style="padding-left: 0px;">
							<input id="cwYingShou-info_fstartdate" type="text"
						...
						<button class="btn btn-small a-search"
							onclick="document.cw-commHt-infoForm.submit()">查询</button>
						&nbsp;
					</form>
				</div>
			</article>
			<article class="m-blank">
				<div class="pull-left">
					<region:region-permission permission="cw-commHt-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='cw-commHt-info-input.do'">新建合同</button>
			...
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="cw-commHt-info.cw-commHt-info.list.title"
							text="列表" />
					</h4>
				</header>
				<div class="content">
					<form id="cw-commHt-infoGridForm" name="cw-commHt-infoGridForm"
						method='post' action="cw-commHt-info-remove.do"
						class="m-form-blank " style=" overflow-x: scroll;">
						<div style="height:5px "></div>
						<table id="cw-commHt-infoGrid"
							class="m-table  table-hover table-responsive table-bordered table-striped "
							data-toggle="table" style="width: 2000px">
							<thead>
								<tr>
									...
									<th class="sorting" id="fzhubanren">申请人</th>
									...
									<th class="sorting" id="fmbzrs">目标责任书</th>
									<th class="sorting" id="fzjcns">总监承诺书</th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr
										ondblclick="window.location='cw-commHt-info-input.do?id=${item.fid}'">
										...
										<td class="span2">${item.fhtname}</td>
										<td>${item.fjiafang}</td>
