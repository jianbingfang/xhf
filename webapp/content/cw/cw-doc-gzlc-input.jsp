    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="cw-doc-gzlc-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodule" value="cw">
			...
			<%--   <div class="control-group">
			 ...
			 <%--   <div class="control-group">
			    <label class="control-label" for="plain-info_fcreator">编制人</label>
				<div class="controls">
			  ...
			  <div class="control-group">
			    <label class="control-label" for="plain-info_fmemo1">流程内容</label>
				<div class="controls">
