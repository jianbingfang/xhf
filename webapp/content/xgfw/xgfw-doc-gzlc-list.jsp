...
var config = {
	...
	gridFormId: 'xgfw-doc-gzlc-infoGridForm',
	exportUrl: 'xgfw-doc-gzlc-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="xgfw-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="xgfw-plain-infoForm" method="post" action="xgfw-doc-gzlc-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xgfw-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xgfw-doc-gzlc-infoGridForm" name="xgfw-doc-gzlc-infoGridForm" method='post' action="xgfw-doc-gzlc-remove.do" class="m-form-blank">
  <table id="xgfw-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="xgfw-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
