...
<%pageContext.setAttribute("currentMenu", "xgfw-plain");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'xgfw-plain-infoGridForm',
	exportUrl: 'xgfw-week-plain-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="xgfw-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="xgfw-plain-infoForm" method="post" action="xgfw-plain-info-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='xgfw-week-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xgfw-plain-infoGridForm" name="xgfw-plain-infoGridForm" method='post' action="xgfw-week-plain-info-remove.do" class="m-form-blank">
  <table id="xgfw-plain-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fmemo5}</td>
        <td>
          <a href="xgfw-week-plain-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
