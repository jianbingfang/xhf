...
var config = {
	...
	gridFormId: 'fgs-doc-glzd-infoGridForm',
	exportUrl: 'fgs-doc-glzd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="fgs-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="fgs-plain-infoForm" method="post" action="fgs-doc-glzd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='fgs-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="fgs-doc-glzd-infoGridForm" name="fgs-doc-glzd-infoGridForm" method='post' action="fgs-doc-glzd-remove.do" class="m-form-blank">
  <table id="fgs-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="fgs-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
