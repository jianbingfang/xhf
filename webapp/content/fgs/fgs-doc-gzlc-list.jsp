...
<%pageContext.setAttribute("currentMenu", "fgs-zd");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'fgs-doc-gzlc-infoGridForm',
	exportUrl: 'fgs-doc-gzlc-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="fgs-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="fgs-plain-infoForm" method="post" action="fgs-doc-gzlc-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='fgs-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="fgs-doc-gzlc-infoGridForm" name="fgs-doc-gzlc-infoGridForm" method='post' action="fgs-doc-gzlc-remove.do" class="m-form-blank">
  <table id="fgs-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="fgs-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
