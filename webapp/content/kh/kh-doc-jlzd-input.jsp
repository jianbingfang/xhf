    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="kh-doc-jlzd-save.do?khtype=${khtype}" class="form-horizontal">
			  ...
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			    ...
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodule" value="kh">
			     <input id="plain-info_ftype" type="hidden" name="ftype" value="12">
