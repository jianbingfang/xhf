    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="khJl-infoSearch" class="content content-inner">
		  ...
		  <form name="khJl-infoForm" method="post" action="khJl-info-list.do?ftype=1" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='khJl-info-input.do?ftype=1'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="khJl-infoGridForm" name="khJl-infoGridForm" method='post' action="khJl-info-remove.do?ftype=1" class="m-form-blank">
    ...
    <thead>
      <tr>
        <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
        	...
        	<th class="sorting" name="fkhzcy">考核组成员</th>
        	<!-- <th class="sorting" name="fkhjg">考核结果</th> -->
        <th width="80">&nbsp;</th>
      </tr>
    </thead>
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	...
      	 	<%--  <td>${item.fkhjg}</td> --%>
        <td>
          <a href="khJl-info-input.do?ftype=1&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
