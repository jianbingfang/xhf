		...
		<section id="m-main" class="span10">
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="khJl-infoForm" method="post" action="khJl-info-save.do?ftype=1"
						...
						<div class="control-group">
							<label class="control-label" for="khJl-info_fkhzcy"><spring:message
									code="khJl-info.khJl-info.input.fkhzcy" text="考核组成员" /></label>
							<div class="controls">
						...
						<div class="control-group">
							<label class="control-label" for="khJl-info_fkhjg"><spring:message
									code="khJl-info.khJl-info.input.fkhjg" text="考核结果" /></label>
							<div class="controls">
