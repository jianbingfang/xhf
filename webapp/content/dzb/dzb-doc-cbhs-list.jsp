...
<%pageContext.setAttribute("currentMenu", "dzb-cbhs");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'dzb-doc-cbhs-infoGridForm',
	exportUrl: 'dzb-doc-cbhs-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='dzb-doc-cbhs-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="dzb-doc-cbhs-infoGridForm" name="dzb-doc-cbhs-infoGridForm" method='post' action="dzb-doc-cbhs-remove.do" class="m-form-blank">
  <table id="dzb-doc-cbhs-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
        <td>
          <a href="dzb-doc-cbhs-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
