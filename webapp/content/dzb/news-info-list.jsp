    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="news-infoSearch" class="content content-inner">
		  ...
		  <form name="news-infoForm" method="post" action="news-info-list.do?ftype=1" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='news-info-input.do?ftype=1'">新建</button>
