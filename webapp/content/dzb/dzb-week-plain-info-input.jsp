    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="dzb-week-plain-info-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodulecode" value="dzb">
