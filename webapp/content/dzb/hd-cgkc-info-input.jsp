			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="hd-infoForm" method="post"
						action="hd-info-save.do?ftype=${param.ftype}"
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
									<textarea id="hd-info_fpxnr" name="fcjry" class="form-control"
										rows="6" style="width: 560px" class="text  " minlength=""
										maxlength="100">${model.fpxnr}</textarea>
								</div>
							</div>
						</div>
						<div class="control-group">
							<div class="control-group">
								<div class="span5">
									<label class="control-label" for="hd-info_fpxnr"><spring:message
											code="hd-info.hd-info.input.fpxnr" text="总结" /></label>
									<div class="controls">
