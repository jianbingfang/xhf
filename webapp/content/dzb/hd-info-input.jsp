...
<form id="hd-infoForm" method="post" action="hd-info-save.do?ftype=${param.ftype }" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="hd-info_id" type="hidden" name="fid" value="${model.fid}">
						...
						<div class="span5">
					    <label class="control-label" for="hd-info_fpxzt"><spring:message code="hd-info.hd-info.input.fpxzt" text="培训主题"/></label>
						<div class="controls">
						...
						<div class="controls">
							  	 <textarea id="hd-info_fpxnr"  name="fcjry"  class="form-control" rows="6"  style="width: 560px" class="text  "  minlength="" maxlength="100">${model.fpxnr}</textarea>
					    </div>
					  </div>
					  </div>
	                   <div class="control-group">
