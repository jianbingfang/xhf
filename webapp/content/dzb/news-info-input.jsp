...
<form id="news-infoForm" method="post" action="news-info-save.do?ftype=1" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="news-info_id" type="hidden" name="fid" value="${model.fid}">
					...
					<div class="controls">
					  	 <input id="news-info_ffwdw" type="text" name="ffwdw" value="${model.ffwdw}" size="" class="text " minlength="" maxlength="">	
				    </div>
				  </div>
			    	<div class="control-group">
