...
<%pageContext.setAttribute("currentMenu", "dzb-gzzj");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'cw-doc-gzzj-infoGridForm',
	exportUrl: 'cw-doc-gzzj-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='cw-doc-gzzj-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cw-doc-gzzj-infoGridForm" name="cw-doc-gzzj-infoGridForm" method='post' action="cw-doc-gzzj-remove.do" class="m-form-blank">
  <table id="cw-doc-gzzj-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <%--     <td><c:if test="${item.fstatus==1}"><font color="#0066CC">试行</font></c:if>
       ...
       <%--  <td>${item.fstartdate}</td>
        ...
        <%-- <td>${item.fcreator}</td> --%>
        <td>
          <a href="cw-doc-gzzj-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
