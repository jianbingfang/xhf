					...
					<form id="plain-infoForm" method="post"
						...
						<div class="control-group">
							<label class="control-label" for="plain-info_fmonth"><spring:message
									code="plain-info.plain-info.input.ftitle" text="年份" /></label>
							<div class="controls">
								<input id="plain-info_ftitle" type="text" name="fmonth"
									value="${model.fmonth}" size="40" class="text required"
									maxlength="20">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input id="plain-info_fstatus" readonly="readonly"
									name="fstatus" value="${model.fstatus}" class="form-control"
									type="text">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<textarea id="plain-info_fcomment" readonly="readonly"
									name="fcomment" class="form-control" rows="6">${model.fcomment}</textarea>
							</div>
						</div>
						<div class="control-group">
							<div class="controls">
