...
<form id="dy-infoForm" method="post" action="dy-info-save.do?ftype=${param.ftype }" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="dy-info_id" type="hidden" name="fid" value="${model.fid}">
					  ...
					  <div class="span5">
					    <label class="control-label" for="dy-info_fqdwjjfzdate"><spring:message code="dy-info.dy-info.input.fqdwjjfzdate" text="确定为积极分子时间"/></label>
						<div class="controls">
						      	 <div class="input-append datepicker date" style="padding-left: 0px;">
							    	<input id="dy-info_fqdwjjfzdate" type="text" name="fqdwjjfzdate" value="${model.fqdwjjfzdate}" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
	 ...
	 <%--  </div>
						...
						<div class="control-group">
					 	<div class="span5">
					    <label class="control-label" for="dy-info_fgzdw"><spring:message code="dy-info.dy-info.input.fgzdw" text="工作单位及职务"/></label>
						<div class="controls">
						      	<textarea id="dy-info_fgzdw"  name="fgzdw"  class="form-control" rows="3"   class="text  "  minlength="" maxlength="200">${model.fgzdw}</textarea>
					    </div>
					    </div>
					 
						<div class="span5">
					    <label class="control-label" for="dy-info_fszdzb"><spring:message code="dy-info.dy-info.input.fszdzb" text="所在党支部"/></label>
						<div class="controls">
							  	 <input id="dy-info_fszdzb" type="text" name="fszdzb" value="${model.fszdzb}" size="" class="text " minlength="" maxlength="">	
					    </div>
					  </div>
	     </div>
