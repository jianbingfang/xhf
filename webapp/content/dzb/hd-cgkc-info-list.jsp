...
<%pageContext.setAttribute("currentMenu", "dzb-hd");%>
<!doctype html>
<html lang="zh">
...
var config = {
	...
	exportUrl: 'hd-info-export.do?ftype=${param.ftype}'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="hd-infoSearch" class="content content-inner">
		  ...
		  <form name="hd-infoForm" method="post" action="hd-info-list.do?ftype=${param.ftype}" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='hd-info-input.do?ftype=${param.ftype}'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="hd-infoGridForm" name="hd-infoGridForm" method='post' action="hd-info-remove.do?ftype=${param.ftype}" class="m-form-blank">
    ...
    <thead>
      <tr>
        <th width="10" class="m-table-check"><input type="checkbox" name="checkAll" onchange="toggleSelectedItems(this.checked)"></th>
        	...
        	<!-- <th class="sorting" name="fpxlb">培训类别</th> -->
        	<th class="sorting" name="fcjry">参加人员</th>
        	<th class="sorting" name="fpxnr">总结</th>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	...
      	 	<%--  <td>${item.fmemo1}</td>
      	 	 <td>${item.fmemo2}</td> --%>
        <td>
          <a href="hd-info-input.do?ftype=${param.ftype}&id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
