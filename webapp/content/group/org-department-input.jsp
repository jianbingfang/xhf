...
<form id="orgForm" method="post" action="org-department-save.do" class="form-horizontal">
  ...
  <div class="control-group">
	...
	<div class="controls">
  	...
  	<div class="control-group">
	    <label class="control-label" for="org_fduty"><spring:message code="hrLz-info.hrLz-info.input.fczbg" text="部门职责"/></label>
		<div class="controls">
		   <textarea id="org_fduty"  name="fduty"  class="form-control" rows="15"  style="width: 560px" class="text required"  minlength="20" maxlength="500">${model.fduty}</textarea>
	    </div>
	  </div>
  <div class="control-group">
    <div class="controls">
