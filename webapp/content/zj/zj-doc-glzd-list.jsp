...
var config = {
	...
	gridFormId: 'zj-doc-glzd-infoGridForm',
	exportUrl: 'zj-doc-glzd-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="zj-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="zj-plain-infoForm" method="post" action="zj-doc-glzd-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='zj-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="zj-doc-glzd-infoGridForm" name="zj-doc-glzd-infoGridForm" method='post' action="zj-doc-glzd-remove.do" class="m-form-blank">
  <table id="zj-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="zj-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
