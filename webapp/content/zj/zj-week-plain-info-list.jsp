...
<%pageContext.setAttribute("currentMenu", "zj-plain");%>
<!doctype html>
<html lang="en">
...
var config = {
	...
	gridFormId: 'zj-plain-infoGridForm',
	exportUrl: 'zj-week-plain-info-export.do'
};
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="zj-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="zj-plain-infoForm" method="post" action="zj-plain-info-list.do" class="form-inline">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='zj-week-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="zj-plain-infoGridForm" name="zj-plain-infoGridForm" method='post' action="zj-week-plain-info-remove.do" class="m-form-blank">
  <table id="zj-plain-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fmemo5}</td>
        <td>
          <a href="zj-week-plain-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
