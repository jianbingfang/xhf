	...
	<!-- 	<div class="container-fluid">
	  ...
	  <%-- <article class="m-widget">
        ...
        <div id="jl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="jl-plain-infoForm" method="post" action="jl-doc-glzd-list.do" class="form-inline">
 ...
 --%>
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='jl-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jl-doc-glzd-infoGridForm" name="jl-doc-glzd-infoGridForm" method='post' action="jl-doc-glzd-remove.do" class="m-form-blank">
  <table id="jl-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fenddate}</td> --%>
        <td>
         <a href="jl-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
      </tr>
      </c:forEach>
    </tbody>
