...
var config = {
	...
	gridFormId: 'gcgl-doc-gzlc-infoGridForm',
	exportUrl: 'gcgl-doc-gzlc-export.do'
};
...
function edit(id){
	window.location.href="gcgl-doc-gzlc-input.do?id="+id;
}
    </script>
  </head>
    ...
    <div class="row-fluid">
	 ...
	 <%--  <article class="m-widget">
        ...
        <div id="gcgl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="gcgl-plain-infoForm" method="post" action="gcgl-doc-gzlc-list.do" class="form-inline">
		    <label for="gcgl-plain-info_name"><spring:message code='gcgl-plain-info.gcgl-plain-info.list.search.name' text='名称'/>:</label>
		    <input type="text" id="gcgl-plain-info_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}">
...
<%-- 
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gcgl-doc-gzlc-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="gcgl-doc-gzlc-infoGridForm" name="gcgl-doc-gzlc-infoGridForm" method='post' action="gcgl-doc-gzlc-remove.do" class="m-form-blank">
  <table id="gcgl-doc-gzlc-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fcreator}</td>
        <td>
          <a href="gcgl-doc-gzlc-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
