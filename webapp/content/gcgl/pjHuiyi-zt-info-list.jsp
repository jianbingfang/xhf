...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="pjHuiyi-zt-infoSearch" class="content content-inner">
                ...
                <form name="pjHuiyi-zt-infoForm" method="post" action="pjHuiyi-zt-info-list.do" class="form-inline">
                    <label for="pjHuiyi-zt-info_name"><spring:message
                            code='pjHuiyi-zt-info.pjHuiyi-zt-info.list.search.name' text='名称'/>:</label>
                    <input type="text" id="pjHuiyi-zt-info_name" name="filter_LIKES_fhyname"
        ...
        <article class="m-blank">
            <div class="pull-left">
                <region:region-permission permission="pjHuiyi-zt-info:create">
                    <button class="btn btn-small a-insert" onclick="location.href='pjHuiyi-zt-info-input.do'">新建
                    </button>
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="pjHuiyi-zt-infoGridForm" name="pjHuiyi-zt-infoGridForm" method='post'
                      action="pjHuiyi-zt-info-remove.do" class="m-form-blank">
                    <table id="pjHuiyi-zt-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item" varStatus="status">
                            <tr>
                                ...
                                <td>
                                    <a href="pjHuiyi-zt-info-input.do?id=${item.fid}" class="a-update"><spring:message
