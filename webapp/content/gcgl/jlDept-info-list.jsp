...
$(function() {
 ...
 <!--    <div class="container-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="jlDept-infoSearch" class="content content-inner">
		  ...
		  <form name="jlDept-infoForm" method="post" action="jlDept-info-list.do" class="form-inline">
		    <label for="jlDept-info_name"><spring:message code='jlDept-info.jlDept-info.list.search.name' text='项目名称'/>:</label>
		    <input type="text" id="jlDept-info_name" name="filter_LIKES_fxmname" value="${param.filter_LIKES_fxmname}">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jlDept-infoGridForm" name="jlDept-infoGridForm" method='post' action="jlDept-info-remove.do" class="m-form-blank">
  <table id="jlDept-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="jlDept-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
