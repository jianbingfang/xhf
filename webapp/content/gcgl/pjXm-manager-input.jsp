...
<form id="pjXm-infoForm" method="post" action="pjXm-manager-save.do" class="form-horizontal">
							...
							<div class="span5">
								...
								<div class="controls">
									<select class="form-control" id="pjXm-info_fxmtype"
										...
										<option value="水利水电工程"	<c:if test="${model.fxmtype=='水利水电工程'}"> selected="selected"  </c:if>>农林工程</option>
