...
<title><spring:message code="dev.jl-plain-info.list.title"
		text="列表" /></title>
<%@include file="/common/s.jsp"%>
<script type="text/javascript">
	var config = {
		id : 'jl-doc-mbzrs-infoGrid',
		pageNo : ${page.pageNo},
		...
		gridFormId : 'jl-doc-mbzrs-infoGridForm',
		exportUrl : 'jl-doc-mbzrs-export.do'
	};
...
<body>
	...
	<div class="row-fluid">
        ...
        <div id="jl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="jl-plain-infoForm" method="post" action="jl-doc-mbzrs-list.do" class="form-inline">
 ...
 --%>
				...
				<div class="pull-left">
					<region:region-permission permission="jl-plain-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='jl-doc-mbzrs-input.do'">新建</button>
			...
			<article class="m-widget">
				<header class="header">
					<h4 class="title">
						<spring:message code="jl-plain-info.jl-plain-info.list.title"
							text="列表" />
					</h4>
				</header>
				<div class="content">
					<form id="jl-doc-mbzrs-infoGridForm"
						name="jl-doc-mbzrs-infoGridForm" method='post'
						action="jl-doc-mbzrs-remove.do" class="m-form-blank">
						<table id="jl-doc-mbzrs-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
        ...
        <td>${item.fenddate}</td> --%>
										<td><a href="jl-doc-mbzrs-input.do?id=${item.fid}"
