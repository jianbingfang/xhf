...
var config = {
	...
	exportUrl: 'gcgl-week-plain-info-export.do'
};
...
<!-- 	<div class="container-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gcgl-week-plain-info-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="gcgl-plain-infoGridForm" name="gcgl-plain-infoGridForm" method='post' action="gcgl-week-plain-info-remove.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>${item.fmemo5}</td>
         <td>${item.fstatus}</td>
        <td>
          <a href="gcgl-week-plain-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
