...
<form id="jlDept-infoForm" method="post" action="jlDept-info-save.do" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="jlDept-info_id" type="hidden" name="fid" value="${model.fid}">
				    ...
				    <label class="control-label" for="jlDept-info_fxmid"><spring:message code="jlDept-info.jlDept-info.input.fxmid" text="项目"/></label>
					<div class="controls">
				...
				<%-- <div class="control-group">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="jlDept-info_floginname"><spring:message code="jlDept-info.jlDept-info.input.floginname" text="登录名"/></label>
					<div class="controls">
					  	 <input id="jlDept-info_floginname" type="text" name="floginname" value="${model.floginname}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
			    	<div class="control-group">
				    <label class="control-label" for="jlDept-info_floginpass"><spring:message code="jlDept-info.jlDept-info.input.floginpass" text="登录密码"/></label>
					<div class="controls">
					  	 <input id="jlDept-info_floginpass" type="password" name="floginpass" value="${model.floginpass}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
