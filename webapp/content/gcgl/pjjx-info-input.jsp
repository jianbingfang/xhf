        ...
        <div class="content content-inner">
            ...
            <form id="pjjx-infoForm" method="post" action="pjjx-info-save.do" class="form-horizontal">
                ...
                <%--<div class="control-group">
                    <label class="control-label" for="pjjx-info_fjxno"><spring:message
                            code="pjjx-info.pjjx-info.input.fjxno" text="序号"/></label>

                    <div class="controls">
                        <input id="pjjx-info_fjxno" type="text" name="fjxno" value="${model.fjxno}" size=""
                ...
                <div class="control-group">
                    <label class="control-label" for="pjjx-info_fjxqihao"><spring:message
                            code="pjjx-info.pjjx-info.input.fjxqihao" text="期号"/></label>

                    <div class="controls">
                        <input id="pjjx-info_fjxqihao" type="text" name="fjxqihao" value="${model.fjxqihao}" size=""
                               class="text" minlength="" maxlength="">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="pjjx-info_fjxdate"><spring:message
                            code="pjjx-info.pjjx-info.input.fjxdate" text="发布时间"/></label>

                    <div class="controls">
                        <div class="input-append datepicker date" style="padding-left: 0px;">
                            <input id="pjjx-info_fjxdate" type="text" name="fjxdate" value="${model.fjxdate}" size="40"
                                   class="text " style="background-color:white;cursor:default; width: 175px;">
                ...
                <div class="control-group">
                    <label class="control-label" for="pjjx-info_fmemo"><spring:message
                            code="pjjx-info.pjjx-info.input.fmemo" text="备注"/></label>

                    <div class="controls">
                        <textarea id="pjjx-info_fmemo" type="text" name="fmemo" rows="6" style="width: 560px" size=""
