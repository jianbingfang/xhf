...
<form id="pjRy-infoForm" method="post" action="pjRy-info-save.do" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="pjRy-info_id" type="hidden" name="fid" value="${model.fid}">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="pjRy-info_fenddate"><spring:message code="pjRy-info.pjRy-info.input.fenddate" text="离开项目时间"/></label>
					<div class="controls">
				      	 <div class="input-append datepicker date" style="padding-left: 0px;">
					    	<input id="pjRy-info_fenddate" type="text" name="fenddate" value="${model.fenddate}" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
					 		 <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
					 	 </div>
				    </div>
				  </div>
			    	<div class="control-group">
				    <label class="control-label" for="pjRy-info_ftel"><spring:message code="pjRy-info.pjRy-info.input.ftel" text="联系方式"/></label>
					<div class="controls">
					  	 <input id="pjRy-info_ftel" type="text" name="ftel" value="${model.ftel}" size="" class="text " minlength="" maxlength="">	
				    </div>
				   </div>
				   ...
				   <div class="control-group">
					...
					<div class="controls">
					  	 <input id="pjRy-info_fmemo" type="text" name="fmemo" value="${model.fmemo}" size="" class="text " minlength="" maxlength="">	
				    </div>
				   </div>
					 	<div class="control-group">
					    <div class="controls">
