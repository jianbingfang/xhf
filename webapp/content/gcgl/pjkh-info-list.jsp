	...
	<!-- 	<div class="container-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="pjkh-infoSearch" class="content content-inner">
		  ...
		  <form name="pjkh-infoForm" method="post" action="pjkh-info-list.do" class="form-inline">
		    <label for="pjkh-info_name"><spring:message code='pjkh-info.pjkh-info.list.search.name' text='项目名称'/>:</label>
		    <input type="text" id="pjkh-info_name" name="filter_LIKES_fxmname" value="${param.filter_LIKES_fxmname}">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='pjkh-info-input.do?fxmid=${fxmid}'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="pjkh-infoGridForm" name="pjkh-infoGridForm" method='post' action="pjkh-info-remove.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fkhscore}</td>
        <td>
          <a href="pjkh-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
