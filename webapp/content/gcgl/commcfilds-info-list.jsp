...
function goBack(){
	//alert($('.tab-pane.active', window.parent.document).html());
	$('.tab-pane.active iframe', window.parent.document).attr('src','jlShizhongTemp-info-listByfcode.do?fcode=${fcode}');
}
    </script>
  </head>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		 <!--  <region:region-permission permission="commcfilds-info:create">
		  ...
		  <button class="btn btn-small a-export" onclick="goBack()">返回</button>
		</div>
