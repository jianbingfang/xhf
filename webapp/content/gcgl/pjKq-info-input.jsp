  ...
  <c:if test="${model != null}">
	  <input id="pjKq-info_id" type="hidden" name="fid" value="${model.fid}">
			    ...
			    <%-- <div class="control-group">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="pjKq-info_fxmid"><spring:message code="pjKq-info.pjKq-info.input.fxmid" text="项目"/></label>
					<div class="controls">
					  	<input id="pjKq-info_fxmid" type="text" name="fxmid" value="${model.fxmid}" size="" class="number   " minlength="" maxlength="">
				    </div>
				  </div>
			    <div class="control-group">
				    <label class="control-label" for="pjKq-info_fyearmonth"><spring:message code="pjKq-info.pjKq-info.input.fyearmonth" text="年月"/></label>
					<div class="controls">
					  	 <input id="pjKq-info_fyearmonth" type="text" name="fyearmonth" value="${model.fyearmonth}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
			    	<%-- <div class="control-group">
