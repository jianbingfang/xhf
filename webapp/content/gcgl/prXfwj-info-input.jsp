        ...
        <div class="content content-inner">
            ...
            <form id="prXfwj-infoForm" method="post" action="prXfwj-info-save.do" class="form-horizontal">
                ...
                <%--<div class="control-group">
                    <label class="control-label" for="prXfwj-info_fwjno"><spring:message
                            code="prXfwj-info.prXfwj-info.input.fwjno" text="序号"/></label>

                    <div class="controls">
                        <input id="prXfwj-info_fwjno" type="text" name="fwjno" value="${model.fwjno}" size=""
                               class="text required" minlength="" maxlength="">
                    </div>
                </div>--%>
                <div class="control-group">
                    <label class="control-label" for="prXfwj-info_fname"><spring:message
                            code="prXfwj-info.prXfwj-info.input.fname" text="名称"/></label>

                    <div class="controls">
                        <input id="prXfwj-info_fname" type="text" name="fname" value="${model.fname}" size=""
                               class="text required" minlength="" maxlength="">
                ...
                <div class="control-group">
                    <label class="control-label" for="prXfwj-info_ffabudate"><spring:message
                            code="prXfwj-info.prXfwj-info.input.ffabudate" text="日期"/></label>

                    <div class="controls">
                        <div class="input-append datepicker date" style="padding-left: 0px;">
                            <input id="prXfwj-info_ffabudate" type="text" name="ffabudate" value="${model.ffabudate}"
                ...
                <div class="control-group">
                    <label class="control-label" for="prXfwj-info_ffilename"><spring:message
                            code="prXfwj-info.prXfwj-info.input.ffilename" text="附件"/></label>
                ...
                <div class="control-group">
                    <label class="control-label" for="prXfwj-info_fcontent"><spring:message
                            code="prXfwj-info.prXfwj-info.input.fcontent" text="内容"/></label>

                    <div class="controls">
                        <textarea id="prXfwj-info_fcontent" name="fcontent" class="form-control" rows="6"
                                  style="width: 560px" class="text  " minlength=""
                                  maxlength="500">${model.fcontent}</textarea>
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label" for="prXfwj-info_fmemo"><spring:message
                            code="prXfwj-info.prXfwj-info.input.fmemo" text="备注"/></label>

                    <div class="controls">
                        <textarea id="prXfwj-info_fmemo" name="fmemo" class="form-control" rows="6" style="width: 560px"
