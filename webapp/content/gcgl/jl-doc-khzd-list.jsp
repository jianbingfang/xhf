...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="dev.jl-plain-info.list.title" text="绩效考核"/></title>
    <%@include file="/common/s.jsp"%>
    <script type="text/javascript">
var config = {
    id: 'jl-doc-khzd-infoGrid',
    pageNo: ${page.pageNo},
	...
	gridFormId: 'jl-doc-khzd-infoGridForm',
	exportUrl: 'jl-doc-khzd-export.do'
};
	...
	<!-- <div class="container-fluid">
	 ...
	 <%--  <article class="m-widget">
        ...
        <div id="jl-plain-infoSearch" class="content content-inner">
		  ...
		  <form name="jl-plain-infoForm" method="post" action="jl-doc-khzd-list.do" class="form-inline">
		    <label for="jl-plain-info_name"><spring:message code='jl-plain-info.jl-plain-info.list.search.name' text='名称'/>:</label>
		     <input type="text" id="jl-plain-info_name" name="filter_LIKES_ftitle" value="${param.filter_LIKES_ftitle}"> 
 ...
 --%>
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='jl-doc-khzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="jl-doc-khzd-infoGridForm" name="jl-doc-khzd-infoGridForm" method='post' action="jl-doc-khzd-remove.do" class="m-form-blank">
  <table id="jl-doc-khzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
    ...
    <tbody>
      ...
      <td>${item.fstartdate}</td>
        <td>${item.fenddate}</td> --%>
        <td>
          <a href="jl-doc-khzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a> 
        </td> 
      </tr>
      </c:forEach>
    </tbody>
