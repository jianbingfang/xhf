            ...
            <div class="content content-inner">
                ...
                <form id="pjYqcheck-infoForm" method="post" action="pjYqcheck-info-save.do" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="pjYqcheck-info_fyiqicode"><spring:message
                                code="pjYqcheck-info.pjYqcheck-info.input.fyiqicode" text="仪器编码"/></label>

                        <div class="controls">
                            <input id="pjYqcheck-info_fyiqicode" type="text" name="fyiqicode" value="${model.fyiqicode}"
                                   size="" class="text" minlength="" maxlength="">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pjYqcheck-info_fcheckdate"><spring:message
                                code="pjYqcheck-info.pjYqcheck-info.input.fcheckdate" text="本次年检时间"/></label>

                        <div class="controls">
                            <div class="input-append datepicker date" style="padding-left: 0px;">
                                <input id="pjYqcheck-info_fcheckdate" type="text" name="fcheckdate"
                                       value="${model.fcheckdate}" size="40" class="text "
                    ...
                    <div class="control-group">
                        <label class="control-label" for="pjYqcheck-info_fcheckresult"><spring:message
                                code="pjYqcheck-info.pjYqcheck-info.input.fcheckresult" text="年检结果"/></label>

                        <div class="controls">
                            <textarea id="pjYqcheck-info_fcheckresult" name="fcheckresult" class="form-control" rows="6"
                                      style="width: 560px" class="text  " minlength=""
                                      maxlength="500">${model.fcheckresult}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pjYqcheck-info_fjingshouren"><spring:message
                                code="pjYqcheck-info.pjYqcheck-info.input.fjingshouren" text="经手人"/></label>

                        <div class="controls">
                            <input id="pjYqcheck-info_fjingshouren" type="text" name="fjingshouren"
                                   value="${model.fjingshouren}" size="" class="text" minlength="" maxlength="">
                        </div>
                    </div>
                    <%--<div class="control-group">
