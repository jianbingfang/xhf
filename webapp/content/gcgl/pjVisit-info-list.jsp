...
<div class="row-fluid">
    ...
    <section id="m-main" class="span10">
        ...
        <article class="m-widget">
            ...
            <div id="pjVisit-infoSearch" class="content content-inner">
                ...
                <form name="pjVisit-infoForm" method="post" action="pjVisit-info-list.do" class="form-inline">
                    <label for="pjVisit-info_name"><spring:message code='pjVisit-info.pjVisit-info.list.search.name'
                                                                   text='项目名称'/>:</label>
                    <input type="text" id="pjVisit-info_name" name="filter_LIKES_fxmname"
        ...
        <article class="m-widget">
            ...
            <div class="content">
                <form id="pjVisit-infoGridForm" name="pjVisit-infoGridForm" method='post'
                      action="pjVisit-info-remove.do" class="m-form-blank">
                    <table id="pjVisit-infoGrid" class="m-table table-hover table-bordered">
                        ...
                        <c:forEach items="${page.result}" var="item" varStatus="status">
                            <tr>
                                ...
                                <td>${item.fhfdate}</td>
                                <td>
                                    <a href="pjVisit-info-input.do?id=${item.fid}" class="a-update"><spring:message
