...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="pjXm-info.pjXm-info.input.title" text="编辑"/></title>
  ...
  <body>
    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
        <header class="header">
		  <h4 class="title"><spring:message code="pjXm-info.pjXm-info.input.title" text="编辑" /></h4>
		</header>

		<div class="content content-inner">

<form id="pjXm-infoForm" method="post" action="pjXm-info-save.do" class="form-horizontal">
 <c:if test="${model != null}">
						...
						<div class="control-group">
							...
							<div class="span5">
								<label class="control-label" for="pjXm-info_fxmprovince"><spring:message
										code="pjXm-info.pjXm-info.input.fxmprovince" text="项目地址" /></label>
								<div class="controls">
									<select id="pjXm-info_fxmprovince" type="text"
										name="fxmprovince" value="${model.fprovince}"
										style="width: 80px" class="text required" minlength=""
										maxlength=""> </select>
										<select id="pjXm-info_fxmcity"
										type="text" name="fxmcity" value="${model.fcity}" size=""
										style="width: 80px" class="text " minlength="" maxlength=""></select>
										<input id="pjXm-info_fxmaddr" type="text" name="fxmaddr"
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="input-append ryPicker">
									<input id="pjXm-info_fxmzongjianid" type="hidden" name="fxmzongjianid"
							...
							<div class="span5">
								<label class="control-label" for="pjXm-info_fjsdwid"><spring:message
										code="pjXm-info.pjXm-info.input.fjsdwid" text="建设单位" /></label>
								<div class="controls">
									<input id="pjXm-info_fjsdwid" type="text" name="fjsdwid"
						...
						<div class="control-group">
							...
							<div class="span5">
								<label class="control-label" for="pjXm-info_fxmzhubanrenid"><spring:message
										code="pjXm-info.pjXm-info.input.fxmzhubanrenid" text="主办人" /></label>
								<div class="controls">		
								<div class="input-append ryPicker">
