            ...
            <div class="content content-inner">
                ...
                <form id="pjWj-infoForm" method="post" action="pjWj-info-save.do" class="form-horizontal">
                    ...
                    <%--<div class="control-group">
                        <label class="control-label" for="pjWj-info_fwenjianno"><spring:message
                                code="pjWj-info.pjWj-info.input.fwenjianno" text="序号"/></label>

                        <div class="controls">
                            <input id="pjWj-info_fwenjianno" type="text" name="fwenjianno" value="${model.fwenjianno}"
                                   size="" class="text required" minlength="" maxlength="">
                        </div>
                    </div>--%>
                    <div class="control-group">
                        <label class="control-label" for="pjWj-info_fzhuti"><spring:message
                                code="pjWj-info.pjWj-info.input.fzhuti" text="主题"/></label>

                        <div class="controls">
                            <input id="pjWj-info_fzhuti" type="text" name="fzhuti" value="${model.fzhuti}" size=""
                                   class="text" minlength="" maxlength="">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="pjWj-info_ffabudate"><spring:message
                                code="pjWj-info.pjWj-info.input.ffabudate" text="发布时间"/></label>

                        <div class="controls">
                            <div class="input-append datepicker date" style="padding-left: 0px;">
                                <input id="pjWj-info_ffabudate" type="text" name="ffabudate" value="${model.ffabudate}"
                                       size="40" class="text "
                    ...
                    <%--   	<div class="control-group">
                       ...
                       --%>
                    <div class="control-group">
                        <label class="control-label" for="pjWj-info_fwebrul"><spring:message
                                code="pjWj-info.pjWj-info.input.fwebrul" text="网页链接"/></label>

                        <div class="controls">
                            <input id="pjWj-info_fwebrul" name="fwebrul" class="form-control" rows="6"
                                   style="width: 560px" class="text  " minlength="" maxlength="500"
                                   value="${model.fwebrul}">
                        </div>
                    </div>

                    <div class="control-group">
                        <label class="control-label" for="pjWj-info_fcontent"><spring:message
                                code="pjWj-info.pjWj-info.input.fcontent" text="文件"/></label>
                    ...
                    <div class="control-group">
                        <label class="control-label" for="pjWj-info_fmemo"><spring:message
                                code="pjWj-info.pjWj-info.input.fmemo" text="备注"/></label>

                        <div class="controls">
                            <textarea id="pjWj-info_fmemo" name="fmemo" class="form-control" rows="6"
