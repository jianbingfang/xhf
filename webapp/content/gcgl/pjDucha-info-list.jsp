  ...
  <body>
    ...
    <div class="row-fluid">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="pjDucha-infoGridForm" name="pjDucha-infoGridForm" method='post' action="pjDucha-info-remove.do" class="m-form-blank">
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fmemo}</td>
        <td>
          <a href="pjDucha-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
