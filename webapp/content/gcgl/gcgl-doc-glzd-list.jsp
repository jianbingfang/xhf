...
var config = {
	...
	gridFormId: 'gcgl-doc-glzd-infoGridForm',
	exportUrl: 'gcgl-doc-glzd-export.do'
};
...
<!-- <div class="container-fluid">
	 <div class="row-fluid">
		<div class="span12">
			<ul class="breadcrumb">
				<li>
					<a href="gcgl-workspace.do">工程管理</a> <span class="divider">/</span>
				</li>
				<li>
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='gcgl-doc-glzd-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="gcgl-doc-glzd-infoGridForm" name="gcgl-doc-glzd-infoGridForm" method='post' action="gcgl-doc-glzd-remove.do" class="m-form-blank">
  <table id="gcgl-doc-glzd-infoGrid" class="m-table table-hover table-bordered">
    <thead>
      <tr>
   ...
   <%--      <td>${item.fstartdate}</td>
        ...
        <td>${item.fcreator}</td> --%>
        <td>
          <a href="gcgl-doc-glzd-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td> 
        <td>${item.fmemo}</td>
      </tr>
      </c:forEach>
