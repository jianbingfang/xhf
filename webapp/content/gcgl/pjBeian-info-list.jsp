...
<div class="row-fluid">
    ...
    <article class="m-widget">
        ...
        <div id="pjBeian-infoSearch" class="content content-inner">
            ...
            <form name="pjBeian-infoForm" method="post" action="pjBeian-info-list.do" class="form-inline">
                <label for="pjBeian-info_name"><spring:message code='pjBeian-info.pjBeian-info.list.search.name'
                                                               text='项目名称'/>:</label>
                <input type="text" id="pjBeian-info_name" name="filter_LIKES_fxmname"
    ...
    <article class="m-widget">
        ...
        <div class="content">
            <form id="pjBeian-infoGridForm" name="pjBeian-infoGridForm" method='post' action="pjBeian-info-remove.do"
                  class="m-form-blank">
                <table id="pjBeian-infoGrid" class="m-table table-hover table-bordered">
                    ...
                    <c:forEach items="${page.result}" var="item" varStatus="status">
                        <tr>
                            ...
                            <td>${item.fmemo}</td>
                            <td>
                                <a href="pjBeian-info-input.do?id=${item.fid}" class="a-update"><spring:message
