        ...
        <div id="pjXm-infoSearch" class="content content-inner">
		  ...
		  <form name="pjXm-infoForm" method="post" action="pjXm-info-list.do" class="form-inline">
		   <label for="pjXm-info_name"><spring:message code='pjXm-info.pjXm-info.list.search.fxmno' text='编号'/>:</label>
		    <input type="text" id="pjXm-info_fxmno" name="filter_LIKES_fxmno" value="${param.filter_LIKES_fxmno}">
		    <label for="pjXm-info_name"><spring:message code='pjXm-info.pjXm-info.list.search.name' text='项目名称'/>:</label>
		    <input type="text" id="pjXm-info_fxmname" name="filter_LIKES_fxmname" value="${param.filter_LIKES_fxmname}" width="100px">
    ...
    <tbody>
      ...
      <tr>
        <td><input type="checkbox" class="selectedItem a-check" name="selectedItem" value="${item.fid}"></td>
      	 	 ...
      	 	 <td>${item.fmemo}</td>
        <td>
          <a href="pjXm-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
