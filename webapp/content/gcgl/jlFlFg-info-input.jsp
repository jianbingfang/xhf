            ...
            <div class="content content-inner">
                ...
                <form id="gcgl-jlFlFg-infoForm" method="post" action="gcgl-jlFlFg-info-save.do" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="gcgl-jlFlFg-info_ftype"><spring:message
                                code="gcgl-jlFlFg-info.gcgl-jlFlFg-info.input.ftype" text="分类"/></label>

                        <div class="controls">
                            <input id="gcgl-jlFlFg-info_ftype" type="text" name="ftype" value="${model.ftype}" size=""
                                   class="text" minlength="" maxlength="">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="gcgl-jlFlFg-info_fname"><spring:message
                                code="gcgl-jlFlFg-info.gcgl-jlFlFg-info.input.fname" text="名称"/></label>

                        <div class="controls">
                            <input id="gcgl-jlFlFg-info_fname" type="text" name="fname" value="${model.fname}" size=""
                                   class="text" minlength="" maxlength="">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="gcgl-jlFlFg-info_content"><spring:message
                                code="gcgl-jlFlFg-info.gcgl-jlFlFg-info.input.content" text="内容"/></label>

                        <div class="controls">
                            <textarea id="gcgl-jlFlFg-info_content" type="text" name="content" class="form-control"
                                      rows="6" style="width: 500px" class="text  required">${model.content}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="gcgl-jlFlFg-info_furl"><spring:message
                                code="gcgl-jlFlFg-info.gcgl-jlFlFg-info.input.furl" text="链接"/></label>

                        <div class="controls">
                            <input id="gcgl-jlFlFg-info_furl" type="text" name="furl" value="${model.furl}"
                                   style="width: 400px" class="text" minlength="" maxlength="512">
                        </div>
                    </div>
                    <%--
                                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="gcgl-jlFlFg-info_forder"><spring:message
                                code="gcgl-jlFlFg-info.gcgl-jlFlFg-info.input.forder" text="显示顺序"/></label>

                        <div class="controls">
                            <input id="gcgl-jlFlFg-info_forder" type="text" name="forder" value="${model.forder}"
