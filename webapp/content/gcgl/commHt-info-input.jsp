			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="commHt-infoForm" method="post"
						action="gcgl-commHt-info-saveinput.do" class="form-horizontal">
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fhetongno" type="text" name="fhetongno" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fhtname" type="text" name="fhtname" disabled
						...
						<div class="control-group">
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fjiafang" type="text" name="fjiafang" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<%-- <input id="commHt-info_fadrr" type="text" name="fadrr"
										...
										<div class="controls"> --%>
								 <input
										id="commHt-info_fadrr" type="text" name="fadrr" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<select id="commHt-info_fprovince" type="text"
														name="fprovince" value="${model.fprovince}" disabled
														style="width:80px;"></select>省 <select
														id="commHt-info_fcity" type="text" name="fcity" disabled
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_ftotalMoney" type="text" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fprojecttype" type="text" name="fscale" disabled
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="commHt-info_fqiandingdate"><spring:message
										...
										text="合同签订时间" /></label>
								<div class="controls">
									<div class="input-append datepick date"
										style="padding-left: 0px;">
										<input id="commHt-info_fqiandingdate" type="text" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<div class="input-append datepick date"
										style="padding-left: 0px;">
										<input id="commHt-info_fstartdate" type="text" disabled
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
									<div class="input-append datepick date"
										style="padding-left: 0px;">
										<input id="commHt-info_fenddate" type="text" name="fenddate" disabled
						...
						<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fhtqi" type="text" disabled
										name="fhtqi" value="${model.fhtqi}" size=""
										class="text " minlength="" maxlength="">
								</div>
							</div>
							</div>
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fjiafang" type="text"
										name="fjianlifei" value="${model.fjianlifei}" size="" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fjianlifeilv" type="text"
										name="fjianlifeilv" value="${model.fjianlifeilv}" size="" disabled
										class="text " minlength="" maxlength="">
								</div>
							</div>
									<div class="span5">
								...
								<div class="controls">
									<select class="form-control" id="jyXm-info_fprojecttype" disabled
						...
						<div class="control-group">
							<div class="span5">
								...
								<div class="controls">
									<textarea id="commHt-info_fpaytype" name="fpaytype" rows="3" disabled
										size="" class="text " minlength="" style="width: 560px;"
						...
						<div class="control-group">
							...
							<div class="span5">
								...
								<div class="controls">
									<select class="form-control" id="commHt-info_fywtype" disabled
							...
							<div class="span5">
								...
								<div class="controls">
									<input id="commHt-info_fmemo4" type="text" name="fmemo4" disabled
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="commHt-info_fgcglfzwz"><spring:message
										code="commHt-info.commHt-info.input.fgcglfzwz" text="放置位置" /></label>
								<div class="controls">
									<input id="commHt-info_fgcfzwz" type="text" name="fgcfzwz"
										value="${model.fgcfzwz}" size="" class="text " maxlength="64">
								</div>
							</div>
							<div class="span5">
								...
								<div class="controls">
										<select id="commHt-info_fjsstate" name="fjsstate" size="" class="text "  disabled >
						...
						<div class="control-group">
							<div class="controls">
								<button type="submit" class="btn a-submit"  formaction="gcgl-commHt-info-save.do">
