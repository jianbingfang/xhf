  ...
  <body>
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="pjRyRecord-infoSearch" class="content content-inner">
		  ...
		  <form name="pjRyRecord-infoForm" method="post" action="pjRyRecord-info-list.do" class="form-inline">
		    <label for="pjRyRecord-info_name"><spring:message code='pjRyRecord-info.pjRyRecord-info.list.search.name' text='名称'/>:</label>
		    <input type="text" id="pjRyRecord-info_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="pjRyRecord-infoGridForm" name="pjRyRecord-infoGridForm" method='post' action="pjRyRecord-info-remove.do" class="m-form-blank">
