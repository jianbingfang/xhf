...
<form id="pjYb-infoForm" method="post" action="pjYb-info-save.do" class="form-horizontal">
  <c:if test="${model != null}">
	  <input id="pjYb-info_id" type="hidden" name="fid" value="${model.fid}">
				    ...
				    <label class="control-label" for="pjYb-info_fno"><spring:message code="pjYb-info.pjYb-info.input.fno" text="序号"/></label>
					<div class="controls">
					  	 <input id="pjYb-info_fno" type="text" name="fno" value="${model.fno}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
			    	<div class="control-group">
				    <label class="control-label" for="pjYb-info_fyearmonth"><spring:message code="pjYb-info.pjYb-info.input.fyearmonth" text="年月"/></label>
					<div class="controls">
					  	 <input id="pjYb-info_fyearmonth" type="text" name="fyearmonth" value="${model.fyearmonth}" size="" class="text required" minlength="" maxlength="">	
				    </div>
				  </div>
			    	<div class="control-group">
				    <label class="control-label" for="pjYb-info_fuploaddate"><spring:message code="pjYb-info.pjYb-info.input.fuploaddate" text="上传时间"/></label>
					<div class="controls">
				      	 <div class="input-append datepicker date" style="padding-left: 0px;">
					    	<input id="pjYb-info_fuploaddate" type="text" name="fuploaddate" value="${model.fuploaddate}" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
			    ...
			    <%-- 	<div class="control-group">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="pjYb-info_fmemo"><spring:message code="pjYb-info.pjYb-info.input.fmemo" text="备注"/></label>
					<div class="controls">
				      	<textarea id="pjYb-info_fmemo"  name="fmemo"  class="form-control" rows="6"  style="width: 560px" class="text  "  minlength="" maxlength="500">${model.fmemo}</textarea>
				    </div>
				  </div>
				  
			    <div class="control-group">
				    <label class="control-label" for="pjYb-info_ffilename"><spring:message code="pjYb-info.pjYb-info.input.ffilename" text=""/>月报</label>
					<div class="controls">
