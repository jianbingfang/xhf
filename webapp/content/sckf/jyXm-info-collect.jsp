								...
								<div class="row-fluid">
									<div class="span5">
										...
										<div class="input-append datepicker date" style="padding-left: 0px;">
												<input id="jyXm-info_fbmksdate" type="text" name="fbmksdate" value="${model.fbmksdate}" size="40" class="text " style="background-color:white;cursor:default; width: 100px;">
												<span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
											</div>至
											<div class="input-append datepicker date" style="padding-left: 0px;floa">
												<input id="jyXm-info_fbmjzdate" type="text" name="fbmjzdate" value="${model.fbmjzdate}" size="40" class="text " style="background-color:white;cursor:default; width:100px;">
												<span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
											</div>
										</div>
									</div>
