  ...
  <body>
    ...
    <div class="row-fluid">
	  ...
	  <article class="m-widget">
        ...
        <div id="xzZjOrder-infoSearch" class="content content-inner">
		  ...
		  <form name="xzZjOrder-infoForm" method="post" action="xzZjOrder-info-list.do" class="form-inline">
		    ...
		    <input type="text" id="xzZjOrder-info_name" name="filter_LIKES_name" value="${param.filter_LIKES_name}">
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="xzZjOrder-infoGridForm" name="xzZjOrder-infoGridForm" method='post' action="xzZjOrder-info-remove.do" class="m-form-blank">
  <table id="xzZjOrder-infoGrid" class="m-table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="xzZjOrder-info-input.do?id=${item.fid}" class="a-update"><spring:message code="core.list.edit" text="编辑"/></a>
        </td>
      </tr>
      </c:forEach>
    </tbody>
