...
<html lang="en">
  ...
  <head>
    ...
    <title><spring:message code="plain-info.plain-info.input.title" text="部门职责 - 管理制度 - 行政管理"/></title>
...
function activeFirst(){
  ...
  <body>
	...
	<section id="m-main" class="span10">
		<a href="sckf-doc-bmze-list.do" style="float: right;">编辑</a>
        ...
        <div id="hrLz-infoSearch" class="content content-inner">
			...
			<form id="plain-infoForm" method="post" action="hr-doc-glzd-save.do" class="form-horizontal">
			  <div class="control-group">
				<div class="controls">
					<label class="control-label" style="width: 400px" for="hrLz-info_fczbg"><spring:message code="hrLz-info.hrLz-info.input.fczbg" text="${model.fbmze}"/></label>
			    </div>
			  </div>
