      ...
      <section id="m-main" class="span10">
			<!-- <div class="container-fluid">
				<ul class="breadcrumb" style="width: 98%">
					...
					<li><a href="sckf-week-plain-info-list.do">工作计划</a><span
		...
		<div class="content content-inner">
			<form id="plain-infoForm" method="post" action="sckf-week-plain-info-save.do" class="form-horizontal">
			  <c:if test="${model != null}">
			  <input id="plain-info_fid" type="hidden" name="fid" value="${model.fid}">
			  </c:if>
			    <input id="plain-info_fmodulecode" type="hidden" name="fmodulecode" value="sckf">
