    ...
    <div class="row-fluid">
	  ...
	  <article class="m-blank">
	    <div class="pull-left">
		  ...
		  <button class="btn btn-small a-insert" onclick="location.href='sckf-xmgz-input.do'">新建</button>
      ...
      <article class="m-widget">
        ...
        <div class="content">
<form id="cw-doc-glzd-infoGridForm" name="cw-doc-glzd-infoGridForm" method='post' action="sckf-xmgz-remove.do" class="m-form-blank">
