			...
			<article class="m-widget">
				...
				<div id="sckf-cwBzj-infoSearch" class="content content-inner">
					...
					<form name="sckf-cwBzj-infoForm" method="post"
						action="sckf-cwBzj-info-list.do?type=1" class="form-inline">
				...
				<div class="pull-left">
					<region:region-permission permission="sckf-cwBzj-info:create">
						<button class="btn btn-small a-insert"
							onclick="location.href='sckf-cwBzj-info-input.do?type=${type}'">新建</button>
						...
						<table id="sckf-cwBzj-infoGrid" class="m-table table-hover table-bordered">
							<thead>
								<tr>
									...
									<th class="sorting" name="fcreatedate">申请日期</th>
									...
									<th class="sorting" name="fmoneydate">审批状态</th>
									<th width="80">&nbsp;</th>
								</tr>
							</thead>
							...
							<tbody>
								<c:forEach items="${page.result}" var="item">
									<tr>
										...
										<td>${item.fmemo4}</td>
										<td><a href="sckf-cwBzj-info-input.do?id=${item.fid}&type=${type}"
