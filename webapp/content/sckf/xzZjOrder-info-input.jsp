...
<html lang="zh">
  ...
  <head>
    ...
    <title><spring:message code="xzZjOrder-info.xzZjOrder-info.input.title" text="编辑"/></title>
...
function changeSearch(){
	$(".searchDiv").hide();
	$("#xzZjOrderList-infoSearch"+$('#zjTypeSelect option:selected').val()).show();
	$('#searChResult').html("");
}
...
function search(){
	...
	$('#searChResult').html("");
	$.ajax({
		url : '${scopePrefix}/sckf/xzZjOrder-info-search-ajax.do?type='+type,
...
function showLessChooseDiv() {
	...
	$("#zjlesschoose").attr("src","../xz/xzZjDxlist-info-lesslist.do?startTime="+startTime+"&endTime="+endTime);
/* 		$(".searchDiv").hide();
	$("#xzZjOrderList-infoSearch1").show();
	$('#searChResult').html(""); */
	$('.lessChooseDiv').modal();
...
function saveSelected(){
	...
	$.ajax({
		url : '${scopePrefix}/sckf/xzZjOrder-info-save-ajax.do',
		contentType: 'application/x-www-form-urlencoded; charset=utf-8',
		type:'POST',
		data: {
...
function loadJyxmInfo(){
	$.ajax({
		url : '${scopePrefix}/sckf/jyxm-info-load-ajax.do',
		contentType: 'application/x-www-form-urlencoded; charset=utf-8',
		type:'POST',
		data: {
			fxmid:$('#xzZjOrder-info_fxmid').val()
		},
		async : false,
		dataType:'json',
		success : function(data) {
			$('#xzZjOrder-info_fkbdate').val(data.fkbdate);
		},
		error:function(){
		}
	});
...
<article class="m-widget">
    ...
    <header class="header">
		<h4 class="title"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.title" text="编辑" /></h4>
	</header>

		<div class="content content-inner" >
<form id="xzZjOrder-infoForm" method="post" action="xzZjOrder-info-save.do" class="form-horizontal">
		 <c:if test="${model != null}">
		 	 <input id="xzZjOrder-info_id" type="hidden" name="fid" value="${model.fid}">
		 </c:if>
		    	<div class="control-group">
			    	<div class="span5">
				    <label class="control-label" for="xzZjOrder-info_ffzrid"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.ffzrid" text="申请人"/></label>
					<div class="controls">
							<div class="input-append ryPicker">
										<input id="xzZjOrder-info_ffzrid" type="hidden"
											name="ffzrid" value="${model.ffzrid}"> <input
											id="ryBxRecord-info_ffzrid" type="text"
											value="${ryMap[model.ffzrid].fname}" disabled
											class=" " value=""> <span class="add-on"
											style="padding-top: 2px; padding-bottom: 2px;"><i
			      ...
			      <div class="span5">
				    <label class="control-label" for="xzZjOrder-info_fxmid"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.fxmid" text="使用项目"/></label>
					<div class="controls">
							<div class="input-append jyxmPicker">
										<input id="xzZjOrder-info_fxmid" type="hidden"
											name="fxmid" value="${model.fxmid}" onchange="loadJyxmInfo()"> <input
				  ...
				  <div class="control-group">
			    	<div class="span5">
					    <label class="control-label" for="xzZjOrder-info_fkbdate"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.fkbdate" text="开标时间"/></label>
						<div class="controls">
					      	 <div class="input-append datepicker date" style="padding-left: 0px;">
						    	<input id="xzZjOrder-info_fkbdate" type="text"  value="${xmMap[model.fxmid].fkbdate}" disabled="disabled" readonly="readonly" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
			    	...
			    	<div class="control-group">
			    	<div class="span5">
				    <label class="control-label" for="xzZjOrder-info_fstarttime"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.fstarttime" text="开始使用时间"/></label>
					<div class="controls">
				      	 <div class="input-append datepicker date" style="padding-left: 0px;">
					    	<input id="xzZjOrder-info_fstarttime" type="text" name="fstarttime" value="${model.fstarttime}" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
					 		 <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
					 	 </div>
				    </div>
				  </div>
			    	<div class="span5">
				    <label class="control-label" for="xzZjOrder-info_fendtime"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.fendtime" text="使用截止时间"/></label>
					<div class="controls">
				      	 <div class="input-append datepicker date" style="padding-left: 0px;">
					    	<input id="xzZjOrder-info_fendtime" type="text" name="fendtime" value="${model.fendtime}" size="40" class="text "   style="background-color:white;cursor:default; width: 175px;">
					 		 <span class="add-on" style="padding-top: 2px; padding-bottom: 2px;"><i class="icon-calendar"></i></span>
					 	 </div>
				    </div>
				  </div>
			    ...
			    <%-- 	<div class="control-group">
			    	...
			    	<div class="control-group">
				    <label class="control-label" for="xzZjOrder-info_fmemo"><spring:message code="xzZjOrder-info.xzZjOrder-info.input.fmemo" text="备注"/></label>
					<div class="controls">
				      	<textarea id="xzZjOrder-info_fmemo"  name="fmemo"  class="form-control" rows="3"  style="width: 560px" class="text  "  minlength="" maxlength="500">${model.fmemo}</textarea>
				    </div>
				  </div>
			  
					 	<div class="control-group">
					    <div class="controls">
					      <button type="button" class="btn" onclick="saveSelected()"><spring:message code='core.input.save' text='保存'/></button>
						  &nbsp;
