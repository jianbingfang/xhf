			...
			<article class="m-widget">
				...
				<div class="content content-inner">
					<form id="sckf-cwBzj-infoForm" method="post"
						action="sckf-cwBzj-info-save.do" class="form-horizontal">
						...
						<div class="control-group">
							<div class="span5">
								<label class="control-label" for="cwBzj-info_fzhubanren"><spring:message
										code="cwBzj-info.cwBzj-info.input.fzhubanren" text="申请日期" /></label>
								<div class="controls">
										<input id="cwBzj-info_fcreatedate" type="text" disabled="disabled" readonly="readonly"
