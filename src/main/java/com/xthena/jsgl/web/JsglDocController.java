...
@Controller
@RequestMapping("jsgl")
public class JsglDocController {
    ...
    @RequestMapping("jsgl-doc-glzd-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodule", "jsgl");
        ...
        return "jsgl/jsgl-doc-glzd-list";
    }

   @RequestMapping("jsgl-doc-glzd-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jsgl/jsgl-doc-glzd-input";
    }

    @RequestMapping("jsgl-doc-glzd-save")
    public String save(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/jsgl/jsgl-doc-glzd-list.do";
    }

    @RequestMapping("jsgl-doc-glzd-remove")
    ...
    @RequestMapping("jsgl-doc-glzd-export")
    ...
    @RequestMapping("jsgl-doc-gzlc-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "jsgl/jsgl-doc-gzlc-list";
    }

   @RequestMapping("jsgl-doc-gzlc-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jsgl/jsgl-doc-gzlc-input";
    }

    @RequestMapping("jsgl-doc-gzlc-save")
    public String save2(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/jsgl/jsgl-doc-gzlc-list.do";
    }

    @RequestMapping("jsgl-doc-gzlc-remove")
    ...
    @RequestMapping("jsgl-doc-gzlc-export")
    ...
    @RequestMapping("jsgl-doc-xctx-list")
    public String list3(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "jsgl/jsgl-doc-xctx-list";
    }

   @RequestMapping("jsgl-doc-xctx-input")
    public String input3(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jsgl/jsgl-doc-xctx-input";
    }

    @RequestMapping("jsgl-doc-xctx-save")
    public String save3(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/jsgl/jsgl-doc-xctx-list.do";
    }

    @RequestMapping("jsgl-doc-xctx-remove")
    ...
    @RequestMapping("jsgl-doc-xctx-export")
