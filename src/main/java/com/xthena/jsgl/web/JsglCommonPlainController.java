...
@Controller
@RequestMapping("jsgl")
public class JsglCommonPlainController {
	@Autowired
    ...
    @RequestMapping("jsgl-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "jsgl");
        ...
        return "jsgl/jsgl-plain-info-list";
    }

    @RequestMapping("jsgl-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jsgl/jsgl-plain-info-input";
    }

    @RequestMapping("jsgl-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/jsgl/jsgl-plain-info-list.do";
    }

    @RequestMapping("jsgl-plain-info-remove")
    ...
    @RequestMapping("jsgl-plain-info-export")
    ...
    @RequestMapping("jsgl-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "jsgl/jsgl-week-plain-info-list";
    }

    @RequestMapping("jsgl-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jsgl/jsgl-week-plain-info-input";
    }

    @RequestMapping("jsgl-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/jsgl/jsgl-week-plain-info-list.do";
    }

    @RequestMapping("jsgl-week-plain-info-remove")
    ...
    @RequestMapping("jsgl-week-plain-info-export")
