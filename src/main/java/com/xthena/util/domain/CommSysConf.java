...
/**
 * CommSysConf entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="t_common_sysconf"
    ,catalog="xhf"
)

public class CommSysConf  implements java.io.Serializable {
    ...
    /** full constructor */
    public CommSysConf(String fcode, String fdefaultvalue, String fvalue, Integer fstatus, String fmemo, String fmemo2, String fmemo1) {
        this.fcode = fcode;
