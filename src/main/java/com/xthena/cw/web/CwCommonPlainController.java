...
@Controller
@RequestMapping("cw")
public class CwCommonPlainController {
	@Autowired
    ...
    @RequestMapping("cw-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "cw");
        ...
        return "cw/cw-plain-info-list";
    }

    @RequestMapping("cw-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "cw/cw-plain-info-input";
    }

    @RequestMapping("cw-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/cw/cw-plain-info-list.do";
    }

    @RequestMapping("cw-plain-info-remove")
    ...
    @RequestMapping("cw-plain-info-export")
    ...
    @RequestMapping("cw-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "cw/cw-week-plain-info-list";
    }

    @RequestMapping("cw-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "cw/cw-week-plain-info-input";
    }

    @RequestMapping("cw-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/cw/cw-week-plain-info-list.do";
    }

    @RequestMapping("cw-week-plain-info-remove")
    ...
    @RequestMapping("cw-week-plain-info-export")
