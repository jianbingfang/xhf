...
/**
 * CwHtfxlist entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "t_cw_htfxlist", catalog = "xhf")
public class CwHtfxlist implements java.io.Serializable {
	...
	/** full constructor */
	public CwHtfxlist(String fquarter, Date fstartdate, Date fenddate,
