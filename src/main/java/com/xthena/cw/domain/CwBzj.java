...
public class CwBzj implements java.io.Serializable {
    ...
    public Double getFjnbksmoney() {
        return this.fjnbksmoney;
    }

    public void setFjnbksmoney(Double fjnbksmoney) {
        this.fjnbksmoney = fjnbksmoney;
    }

    @Column(name = "fjnyingsmoney", precision = 20)
    public Double getFjnyingsmoney() {
        return this.fjnyingsmoney;
    }

    public void setFjnyingsmoney(Double fjnyingsmoney) {
        this.fjnyingsmoney = fjnyingsmoney;
    }

    @Column(name = "fjnyismoney", precision = 20)
    public Double getFjnyismoney() {
        return this.fjnyismoney;
    }
