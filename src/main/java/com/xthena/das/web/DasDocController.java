...
public class DasDocController {
    ...
    @RequestMapping("das-doc-glzd-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodule", "das");
        ...
        return "das/das-doc-glzd-list";
    }

   @RequestMapping("das-doc-glzd-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "das/das-doc-glzd-input";
    }

    @RequestMapping("das-doc-glzd-save")
    public String save(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/das/das-doc-glzd-list.do";
    }

    @RequestMapping("das-doc-glzd-remove")
    ...
    @RequestMapping("das-doc-glzd-export")
    ...
    @RequestMapping("das-doc-gzlc-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "das/das-doc-gzlc-list";
    }

   @RequestMapping("das-doc-gzlc-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "das/das-doc-gzlc-input";
    }

    @RequestMapping("das-doc-gzlc-save")
    public String save2(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/das/das-doc-gzlc-list.do";
    }

    @RequestMapping("das-doc-gzlc-remove")
    ...
    @RequestMapping("das-doc-gzlc-export")
    ...
    @RequestMapping("das-doc-xctx-list")
    public String list3(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "das/das-doc-xctx-list";
    }

   @RequestMapping("das-doc-xctx-input")
    public String input3(@RequestParam(value = "id", required = false) Long id,
        ...
        return "das/das-doc-xctx-input";
    }

    @RequestMapping("das-doc-xctx-save")
    public String save3(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/das/das-doc-xctx-list.do";
    }

    @RequestMapping("das-doc-xctx-remove")
    ...
    @RequestMapping("das-doc-xctx-export")
