...
@Controller
@RequestMapping("zjzx")
public class ZjzxCommonPlainController {
	@Autowired
    ...
    @RequestMapping("zjzx-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "zjzx");
        ...
        return "zjzx/zjzx-plain-info-list";
    }

    @RequestMapping("zjzx-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zjzx/zjzx-plain-info-input";
    }

    @RequestMapping("zjzx-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zjzx/zjzx-plain-info-list.do";
    }

    @RequestMapping("zjzx-plain-info-remove")
    ...
    @RequestMapping("zjzx-plain-info-export")
    ...
    @RequestMapping("zjzx-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "zjzx/zjzx-week-plain-info-list";
    }

    @RequestMapping("zjzx-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zjzx/zjzx-week-plain-info-input";
    }

    @RequestMapping("zjzx-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zjzx/zjzx-week-plain-info-list.do";
    }

    @RequestMapping("zjzx-week-plain-info-remove")
    ...
    @RequestMapping("zjzx-week-plain-info-export")
