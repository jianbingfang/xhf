...
/**
 * HrJiaqi entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name="t_hr_jiaqi"
    ,catalog="xhf"
)

public class HrJiaqi  implements java.io.Serializable {
    ...
    /** full constructor */
    public HrJiaqi(Long fryid, Long fdept, String ftype, String fresult, Date fstartdate, Date fenddate, String fstatus, String fmemo, String fgz) {
        this.fryid = fryid;
        this.fdept = fdept;
        this.ftype = ftype;
