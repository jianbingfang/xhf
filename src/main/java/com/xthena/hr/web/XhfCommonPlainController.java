...
@Controller
@RequestMapping("hr")
public class XhfCommonPlainController {
    ...
    @RequestMapping("hr-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "hr");
        ...
        return "hr/hr-plain-info-list";
    }

    @RequestMapping("hr-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "hr/hr-plain-info-input";
    }

    @RequestMapping("hr-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        xhfCommonPlainManager.savePlain(xhfCommonPlain);

        messageHelper.addFlashMessage(redirectAttributes, "core.success.save",
                "保存成功");

        return "redirect:/hr/hr-plain-info-list.do";
    }

    @RequestMapping("hr-plain-info-remove")
    ...
    @RequestMapping("hr-plain-info-export")
    ...
    @RequestMapping("hr-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "hr/hr-week-plain-info-list";
    }

    @RequestMapping("hr-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "hr/hr-week-plain-info-input";
    }

    @RequestMapping("hr-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        if (id != null) {
            ...
            dest = xhfCommonPlain;
            dest.setFcode(CodeUtil.getSysMothCode(ConstValue.SYS_CODE_PLAIN, 4, codeGenManager));
            dest.setFsubdate(new Date());
            dest.setFuserid(Long.valueOf(SpringSecurityUtils.getCurrentUserId()));
        }

        xhfCommonPlainManager.savePlain(dest);

        messageHelper.addFlashMessage(redirectAttributes, "core.success.save",
                "保存成功");

        return "redirect:/hr/hr-week-plain-info-list.do";
    }

    @RequestMapping("hr-week-plain-info-remove")
    ...
    @RequestMapping("hr-week-plain-info-export")
