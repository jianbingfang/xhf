...
public class JyXm  implements java.io.Serializable {
    ...
    public String getFshuxing() {
        return this.fshuxing;
    }
    
    public void setFshuxing(String fshuxing) {
        this.fshuxing = fshuxing;
    }
