...
@Controller
@RequestMapping("sckf")
public class SckfXzZjOrderListController {
    ...
    public String list(@ModelAttribute Page page,
        ...
        return "sckf/xzZjOrderList-info-list";
    }
    ...
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "sckf/xzZjOrderList-info-input";
    }
    ...
    public String save(@ModelAttribute XzZjOrderList xzZjOrderList,
        ...
        return "redirect:/sckf/xzZjOrderList-info-list.do";
    }
