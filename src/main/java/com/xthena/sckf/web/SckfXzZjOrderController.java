...
@Controller
@RequestMapping("sckf")
public class SckfXzZjOrderController {
...
//		JsonResponseUtil.write(response, page);
    ...
    public String list(@ModelAttribute Page page,
        ...
        return "sckf/xzZjOrder-info-list";
    }
    ...
    public void xzZjOrderDelete(@RequestParam(value = "fid", required = false) long fid, HttpServletResponse response) {
    ...
    public void ajaxSearch(@ModelAttribute Page page,
        ...
        if (type.equals("1")) {
      	  ...
      	  */
            ...
            hql = "select xzZjDxlist ,( case when exists(select 1 from XzZjOrder zjO,XzZjOrderList zjOl where zjOl.forderid=zjO.fid and" +
                    "((zjO.fstarttime between '" + startTime + "' and '" + endTime + "' ) or (zjO.fendtime between '" + startTime + "' and '" + endTime + "')) " +
                    " and (zjO.fstatus ='已申请' or zjO.fstatus ='已领取') " +
                    " and xzZjDxlist.fid=zjOl.fzjid) then 1 else 0 end) as forderstatus from  XzZjDxlist  xzZjDxlist,CommHt commht,CommRy ry where  "
                    + " xzZjDxlist.fzjid=commht.fid and commht.fzongjian=ry.fid and xzZjDxlist.ftype=4  ";
    ...
    public String save(@ModelAttribute XzZjOrder xzZjOrder,
        ...
        return "redirect:/sckf/xzZjOrder-info-list.do";
    }
