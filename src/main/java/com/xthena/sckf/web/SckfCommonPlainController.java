...
@Controller
@RequestMapping("sckf")
public class SckfCommonPlainController {
	@Autowired
    ...
    @RequestMapping("sckf-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "sckf");
        ...
        return "sckf/sckf-plain-info-list";
    }

    @RequestMapping("sckf-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "sckf/sckf-plain-info-input";
    }

    @RequestMapping("sckf-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/sckf/sckf-plain-info-list.do";
    }

    @RequestMapping("sckf-plain-info-remove")
    ...
    @RequestMapping("sckf-plain-info-export")
    ...
    @RequestMapping("sckf-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "sckf/sckf-week-plain-info-list";
    }

    @RequestMapping("sckf-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "sckf/sckf-week-plain-info-input";
    }

    @RequestMapping("sckf-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/sckf/sckf-week-plain-info-list.do";
    }

    @RequestMapping("sckf-week-plain-info-remove")
    ...
    @RequestMapping("sckf-week-plain-info-export")
