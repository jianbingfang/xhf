...
@Controller
@RequestMapping("xgfw")
public class XgfwCommonPlainController {
	@Autowired
    ...
    @RequestMapping("xgfw-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "xgfw");
        ...
        return "xgfw/xgfw-plain-info-list";
    }

    @RequestMapping("xgfw-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xgfw/xgfw-plain-info-input";
    }

    @RequestMapping("xgfw-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/xgfw/xgfw-plain-info-list.do";
    }

    @RequestMapping("xgfw-plain-info-remove")
    ...
    @RequestMapping("xgfw-plain-info-export")
    ...
    @RequestMapping("xgfw-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "xgfw/xgfw-week-plain-info-list";
    }

    @RequestMapping("xgfw-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xgfw/xgfw-week-plain-info-input";
    }

    @RequestMapping("xgfw-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/xgfw/xgfw-week-plain-info-list.do";
    }

    @RequestMapping("xgfw-week-plain-info-remove")
    ...
    @RequestMapping("xgfw-week-plain-info-export")
