...
@Controller
@RequestMapping("xgfw")
public class XgfwDocController {
    ...
    @RequestMapping("xgfw-doc-glzd-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodule", "xgfw");
        ...
        return "xgfw/xgfw-doc-glzd-list";
    }

   @RequestMapping("xgfw-doc-glzd-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xgfw/xgfw-doc-glzd-input";
    }

    @RequestMapping("xgfw-doc-glzd-save")
    public String save(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/xgfw/xgfw-doc-glzd-list.do";
    }

    @RequestMapping("xgfw-doc-glzd-remove")
    ...
    @RequestMapping("xgfw-doc-glzd-export")
    ...
    @RequestMapping("xgfw-doc-gzlc-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "xgfw/xgfw-doc-gzlc-list";
    }

   @RequestMapping("xgfw-doc-gzlc-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xgfw/xgfw-doc-gzlc-input";
    }

    @RequestMapping("xgfw-doc-gzlc-save")
    public String save2(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/xgfw/xgfw-doc-gzlc-list.do";
    }

    @RequestMapping("xgfw-doc-gzlc-remove")
    ...
    @RequestMapping("xgfw-doc-gzlc-export")
    ...
    @RequestMapping("xgfw-doc-xctx-list")
    public String list3(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "xgfw/xgfw-doc-xctx-list";
    }

   @RequestMapping("xgfw-doc-xctx-input")
    public String input3(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xgfw/xgfw-doc-xctx-input";
    }

    @RequestMapping("xgfw-doc-xctx-save")
    public String save3(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/xgfw/xgfw-doc-xctx-list.do";
    }

    @RequestMapping("xgfw-doc-xctx-remove")
    ...
    @RequestMapping("xgfw-doc-xctx-export")
