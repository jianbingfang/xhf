...
@Controller
@RequestMapping("gh")
public class GhCommonPlainController {
	@Autowired
    ...
    @RequestMapping("gh-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "gh");
        ...
        return "gh/gh-plain-info-list";
    }

    @RequestMapping("gh-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "gh/gh-plain-info-input";
    }

    @RequestMapping("gh-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/gh/gh-plain-info-list.do";
    }

    @RequestMapping("gh-plain-info-remove")
    ...
    @RequestMapping("gh-plain-info-export")
    ...
    @RequestMapping("gh-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "gh/gh-week-plain-info-list";
    }

    @RequestMapping("gh-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "gh/gh-week-plain-info-input";
    }

    @RequestMapping("gh-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/gh/gh-week-plain-info-list.do";
    }

    @RequestMapping("gh-week-plain-info-remove")
    ...
    @RequestMapping("gh-week-plain-info-export")
