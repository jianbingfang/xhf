...
@Controller
@RequestMapping("fgs")
public class FgsCommonPlainController {
	@Autowired
    ...
    @RequestMapping("fgs-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "fgs");
        ...
        return "fgs/fgs-plain-info-list";
    }

    @RequestMapping("fgs-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "fgs/fgs-plain-info-input";
    }

    @RequestMapping("fgs-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/fgs/fgs-plain-info-list.do";
    }

    @RequestMapping("fgs-plain-info-remove")
    ...
    @RequestMapping("fgs-plain-info-export")
    ...
    @RequestMapping("fgs-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "fgs/fgs-week-plain-info-list";
    }

    @RequestMapping("fgs-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "fgs/fgs-week-plain-info-input";
    }

    @RequestMapping("fgs-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/fgs/fgs-week-plain-info-list.do";
    }

    @RequestMapping("fgs-week-plain-info-remove")
    ...
    @RequestMapping("fgs-week-plain-info-export")
