...
@Controller
@RequestMapping("zj")
public class ZjCommonPlainController {
	@Autowired
    ...
    @RequestMapping("zj-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "zj");
        ...
        return "zj/zj-plain-info-list";
    }

    @RequestMapping("zj-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zj/zj-plain-info-input";
    }

    @RequestMapping("zj-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zj/zj-plain-info-list.do";
    }

    @RequestMapping("zj-plain-info-remove")
    ...
    @RequestMapping("zj-plain-info-export")
    ...
    @RequestMapping("zj-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "zj/zj-week-plain-info-list";
    }

    @RequestMapping("zj-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zj/zj-week-plain-info-input";
    }

    @RequestMapping("zj-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zj/zj-week-plain-info-list.do";
    }

    @RequestMapping("zj-week-plain-info-remove")
    ...
    @RequestMapping("zj-week-plain-info-export")
