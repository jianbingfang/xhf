...
public class DzbDocController {
  ...
  // ==============================================================================
    ...
    @RequestMapping("dzb-doc-cbhs-list")
    public String listcbhs(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodule", "dzb");
        ...
        return "dzb/dzb-doc-cbhs-list";
    }

   @RequestMapping("dzb-doc-cbhs-input")
    public String inputcbhs(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-doc-cbhs-input";
    }

    @RequestMapping("dzb-doc-cbhs-save")
    public String savecbhs(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-cbhs-list.do";
    }

    @RequestMapping("dzb-doc-cbhs-remove")
    ...
    @RequestMapping("dzb-doc-cbhs-export")
    ...
    @RequestMapping("dzb-doc-gzzj-list")
    public String listgzzj(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "dzb/dzb-doc-gzzj-list";
    }

   @RequestMapping("dzb-doc-gzzj-input")
    public String inputgzzj(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-doc-gzzj-input";
    }

    @RequestMapping("dzb-doc-gzzj-save")
    public String savegzzj(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-gzzj-list.do";
    }

    @RequestMapping("dzb-doc-gzzj-remove")
    ...
    @RequestMapping("dzb-doc-gzzj-export")
   ...
   //======================================================================================
    @RequestMapping("dzb-doc-glzd-list")
    public String list(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "dzb/dzb-doc-glzd-list";
    }

   @RequestMapping("dzb-doc-glzd-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-doc-glzd-input";
    }

    @RequestMapping("dzb-doc-glzd-save")
    public String save(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-glzd-list.do";
    }

    @RequestMapping("dzb-doc-glzd-remove")
    ...
    @RequestMapping("dzb-doc-glzd-export")
    ...
    //==================================================
    @RequestMapping("dzb-doc-gzlc-list")
    public String list2(@ModelAttribute Page page,
        ...
        return "dzb/dzb-doc-gzlc-list";
    }

   @RequestMapping("dzb-doc-gzlc-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-doc-gzlc-input";
    }

    @RequestMapping("dzb-doc-gzlc-save")
    public String save2(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-gzlc-list.do";
    }

    @RequestMapping("dzb-doc-gzlc-remove")
    ...
    @RequestMapping("dzb-doc-gzlc-export")
    ...
    @RequestMapping("dzb-doc-xctx-list")
    public String list3(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "dzb/dzb-doc-xctx-list";
    }

   @RequestMapping("dzb-doc-xctx-input")
    public String input3(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-doc-xctx-input";
    }

    @RequestMapping("dzb-doc-xctx-save")
    public String save3(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-xctx-list.do";
    }

    @RequestMapping("dzb-doc-xctx-remove")
    ...
    @RequestMapping("dzb-doc-xctx-export")
    ...
    @RequestMapping("dzb-doc-bmze-list")
    public String bmzelist(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "dzb/dzb-bmze-list";
    }

   @RequestMapping("dzb-doc-bmze-input")
    public String bmzeinput(@RequestParam(value = "id", required = false) Long id,
        ...
        return "dzb/dzb-bmze-input";
    }

    @RequestMapping("dzb-doc-bmze-save")
    public String bmzesave(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/dzb/dzb-doc-bmze-list.do";
    }

    @RequestMapping("dzb-doc-bmze-remove")
    ...
    @RequestMapping("dzb-doc-bmze-export")
    ...
    @RequestMapping("dzb-doc-bmze-info")
