...
@Controller
@RequestMapping("zbdl")
public class ZbdlCommonPlainController {
	@Autowired
    ...
    @RequestMapping("zbdl-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "zbdl");
        ...
        return "zbdl/zbdl-plain-info-list";
    }

    @RequestMapping("zbdl-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zbdl/zbdl-plain-info-input";
    }

    @RequestMapping("zbdl-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zbdl/zbdl-plain-info-list.do";
    }

    @RequestMapping("zbdl-plain-info-remove")
    ...
    @RequestMapping("zbdl-plain-info-export")
    ...
    @RequestMapping("zbdl-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "zbdl/zbdl-week-plain-info-list";
    }

    @RequestMapping("zbdl-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zbdl/zbdl-week-plain-info-input";
    }

    @RequestMapping("zbdl-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/zbdl/zbdl-week-plain-info-list.do";
    }

    @RequestMapping("zbdl-week-plain-info-remove")
    ...
    @RequestMapping("zbdl-week-plain-info-export")
