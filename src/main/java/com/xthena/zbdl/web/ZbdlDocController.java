...
@Controller
@RequestMapping("zbdl")
public class ZbdlDocController {
    ...
    @RequestMapping("zbdl-doc-glzd-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodule", "zbdl");
        ...
        return "zbdl/zbdl-doc-glzd-list";
    }

   @RequestMapping("zbdl-doc-glzd-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zbdl/zbdl-doc-glzd-input";
    }

    @RequestMapping("zbdl-doc-glzd-save")
    public String save(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/zbdl/zbdl-doc-glzd-list.do";
    }

    @RequestMapping("zbdl-doc-glzd-remove")
    ...
    @RequestMapping("zbdl-doc-glzd-export")
    ...
    @RequestMapping("zbdl-doc-gzlc-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "zbdl/zbdl-doc-gzlc-list";
    }

   @RequestMapping("zbdl-doc-gzlc-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zbdl/zbdl-doc-gzlc-input";
    }

    @RequestMapping("zbdl-doc-gzlc-save")
    public String save2(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/zbdl/zbdl-doc-gzlc-list.do";
    }

    @RequestMapping("zbdl-doc-gzlc-remove")
    ...
    @RequestMapping("zbdl-doc-gzlc-export")
    ...
    @RequestMapping("zbdl-doc-xctx-list")
    public String list3(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "zbdl/zbdl-doc-xctx-list";
    }

   @RequestMapping("zbdl-doc-xctx-input")
    public String input3(@RequestParam(value = "id", required = false) Long id,
        ...
        return "zbdl/zbdl-doc-xctx-input";
    }

    @RequestMapping("zbdl-doc-xctx-save")
    public String save3(@ModelAttribute  XhfCommonDoc xhfCommonDoc,
        ...
        return "redirect:/zbdl/zbdl-doc-xctx-list.do";
    }

    @RequestMapping("zbdl-doc-xctx-remove")
    ...
    @RequestMapping("zbdl-doc-xctx-export")
