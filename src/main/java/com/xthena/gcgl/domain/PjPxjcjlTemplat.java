 ...
 */
@Entity
@Table(name="t_pj_pxjcjl_templat"
    ,catalog="xhf"
)

public class PjPxjcjlTemplat  implements java.io.Serializable {
    ...
    /** default constructor */
    public PjPxjcjlTemplat() {
    }

    
    /** full constructor */
    public PjPxjcjlTemplat(String fname, String fcontent, String fstatus, Date fcreatedate) {
        this.fname = fname;
