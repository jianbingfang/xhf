...
public class PjYb  implements java.io.Serializable {
    ...
    /** full constructor */
    public PjYb(String fno, String fyearmonth, Date fuploaddate, Long fuploadry, String fmemo, String ffilename, String ffileurl) {
        this.fno = fno;
