...
@Controller
@RequestMapping("gcgl")
public class GcglCommonPlainController {
	@Autowired
    ...
    @RequestMapping("gcgl-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "gcgl");
        ...
        return "gcgl/gcgl-plain-info-list";
    }

    @RequestMapping("gcgl-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "gcgl/gcgl-plain-info-input";
    }

    @RequestMapping("gcgl-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/gcgl/gcgl-plain-info-list.do";
    }

    @RequestMapping("gcgl-plain-info-remove")
    ...
    @RequestMapping("gcgl-plain-info-export")
    ...
    @RequestMapping("gcgl-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "gcgl/gcgl-week-plain-info-list";
    }

    @RequestMapping("gcgl-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "gcgl/gcgl-week-plain-info-input";
    }

    @RequestMapping("gcgl-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/gcgl/gcgl-week-plain-info-list.do";
    }

    @RequestMapping("gcgl-week-plain-info-remove")
    ...
    @RequestMapping("gcgl-week-plain-info-export")
