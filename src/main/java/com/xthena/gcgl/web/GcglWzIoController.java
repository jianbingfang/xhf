...
@Controller
@RequestMapping("gcgl")
public class GcglWzIoController {
	...
	public String list(@ModelAttribute Page page,
		...
		StringBuffer hql = new StringBuffer(
				"select io from WzList as wz,WzIo as io where wz.fid=io.fwzid and wz.ftype=4 ");
	...
	public String save(@ModelAttribute WzIo wzIo,
		...
		return "redirect:/gcgl/wzIo-info-list.do";
	}
