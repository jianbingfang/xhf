 ...
 */
@Entity
@Table(name="t_jl_doc_template"
    ,catalog="xhf"
)

public class JlDocTemplate  implements java.io.Serializable {
    ...
    /** default constructor */
    public JlDocTemplate() {
    }

    
    /** full constructor */
    public JlDocTemplate(String fname, String fcode, String fcontent, Date fcreatedate, Date fupdatedate, Long fcreateuser, Long fupdateuser, String fmemo, String fmemo1, String fmemo2, String fmemo3) {
        this.fname = fname;
        this.fcode = fcode;
