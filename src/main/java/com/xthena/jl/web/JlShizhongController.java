...
public class JlShizhongController {
    ...
    public String save(@ModelAttribute JlShiZhongAndFujianArray jlShiZhongAndFujianArray, @RequestParam(value = "style", required = false) String style,
        ...
        messageHelper.addFlashMessage(redirectAttributes, "core.success.save",
                "保存成功");
        return "redirect:/jl/jlShizhong-info-list.do?fszleix=" + jlShiZhongAndFujianArray.getJlShizhong().getFszleix() + "&style=" + style + "&id=" + jlShiZhongAndFujianArray.getJlShizhong().getFid();
    }
    ...
    public String remove(@RequestParam("selectedItem") List<Long> selectedItem,
        ...
        return "redirect:/jl/jlShizhong-info-list.do?id=" + jlShizhongs.get(0).getFid() + "&fszleix=" + fszleix + "&divStyle=" + style;
    }
