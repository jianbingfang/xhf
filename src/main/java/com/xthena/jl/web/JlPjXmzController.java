...
@Controller
@RequestMapping("jl")
public class JlPjXmzController {
    ...
    @RequestMapping("jl-pjXmz-info-list")
    public String list(@ModelAttribute Page page,
        ...
        for(PjXmz pjXmz:pjXmzs){
        	pjXmz.setFjieshouren(commRyManager.get(pjXmz.getFjieshourenid()).getFname());
         	pjXmz.setFyijiaoren(commRyManager.get(pjXmz.getFyijiaorenid()).getFname());
        }
        
        model.addAttribute("page", page);

        return "jl/pjXmz-info-list";
    }

    @RequestMapping("jl-pjXmz-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jl/pjXmz-info-input";
    }

    @RequestMapping("jl-pjXmz-info-save")
    public String save(@ModelAttribute PjXmz pjXmz,
        ...
        return "redirect:/jl/jl-pjXmz-info-list.do";
    }

    @RequestMapping("jl-pjXmz-info-remove")
    ...
    @RequestMapping("jl-pjXmz-info-export")
