...
@Controller
@RequestMapping("jl")
public class JlCommonPlainController {
	@Autowired
    ...
    @RequestMapping("jl-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "jl");
        ...
        return "jl/jl-plain-info-list";
    }

    @RequestMapping("jl-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jl/jl-plain-info-input";
    }

    @RequestMapping("jl-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/jl/jl-plain-info-list.do";
    }

    @RequestMapping("jl-plain-info-remove")
    ...
    @RequestMapping("jl-plain-info-export")
    ...
    @RequestMapping("jl-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "jl/jl-week-plain-info-list";
    }

    @RequestMapping("jl-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "jl/jl-week-plain-info-input";
    }

    @RequestMapping("jl-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/jl/jl-week-plain-info-list.do";
    }

    @RequestMapping("jl-week-plain-info-remove")
    ...
    @RequestMapping("jl-week-plain-info-export")
