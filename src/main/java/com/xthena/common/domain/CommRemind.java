...
public class CommRemind  implements java.io.Serializable {
    ...
    /** full constructor */
    public CommRemind(String fname, Long fremindry, Timestamp fremindtime, String fstatus, String fremindcontent, Long fconfid, Integer fremindcont, Integer ftimes, String fremindurl, Long fdataid) {
        this.fname = fname;
