...
public class CommRemindController {
    ...
    public void remind(@ModelAttribute Page page,HttpServletResponse response,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	JsonResponseUtil.write(response, commRemindManager.get(Long.valueOf(String.valueOf(parameterMap.get("fid")))));
    }

    
    @RequestMapping("remind-done-ajax")
    public void done(@ModelAttribute Page page,HttpServletResponse response,
            @RequestParam Map<String, Object> parameterMap, Model model) {
      CommRemind commRemind=commRemindManager.get(Long.valueOf(String.valueOf(parameterMap.get("fid"))));
    ...
    public void delay(@ModelAttribute Page page,HttpServletResponse response,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    		...
    		CommRemind commRemind=commRemindManager.get(Long.valueOf(String.valueOf(parameterMap.get("fid"))));
		  	...
		  	Date date;
			try {
				date = sf.parse(String.valueOf(parameterMap.get("nextRemindDate")));
    ...
    public void ignore(@ModelAttribute Page page,HttpServletResponse response,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    		CommRemind commRemind=commRemindManager.get(Long.valueOf(String.valueOf(parameterMap.get("fid"))));
