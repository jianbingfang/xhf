...
@Controller
@RequestMapping("xz")
public class XzglCommonPlainController {
	@Autowired
    ...
    @RequestMapping("xz-plain-info-list")
    public String list(@ModelAttribute Page page,
            @RequestParam Map<String, Object> parameterMap, Model model) {
    	parameterMap.put("filter_EQS_fmodulecode", "xz");
        ...
        return "xz/xz-plain-info-list";
    }

    @RequestMapping("xz-plain-info-input")
    public String input(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xz/xz-plain-info-input";
    }

    @RequestMapping("xz-plain-info-save")
    public String save(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/xz/xz-plain-info-list.do";
    }

    @RequestMapping("xz-plain-info-remove")
    ...
    @RequestMapping("xz-plain-info-export")
    ...
    @RequestMapping("xz-week-plain-info-list")
    public String list2(@ModelAttribute Page page,
        ...
        model.addAttribute("page", page);
        return "xz/xz-week-plain-info-list";
    }

    @RequestMapping("xz-week-plain-info-input")
    public String input2(@RequestParam(value = "id", required = false) Long id,
        ...
        return "xz/xz-week-plain-info-input";
    }

    @RequestMapping("xz-week-plain-info-save")
    public String save2(@ModelAttribute  XhfCommonPlain xhfCommonPlain,
        ...
        return "redirect:/xz/xz-week-plain-info-list.do";
    }

    @RequestMapping("xz-week-plain-info-remove")
    ...
    @RequestMapping("xz-week-plain-info-export")
